...
\begin{equation}
\textstyle\sum_{k=1}^{\infty} a_k = s \iff n \uparrow \;\Rightarrow \Bigl( \textstyle\sum_{k=1}^{n} a_k - s \Bigr) \cin \forall\fex \mathsf{U}
\end{equation}
where ${\forall\fex \mathsf{U}}$ is any open neighborhood of 0.

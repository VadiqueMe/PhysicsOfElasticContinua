...
\en{The tensor of the parity of permutations}\ru{Тензор чётности перестановок}~$\levicivitatensor$
\en{is antisymmetric}\ru{антисимметричен} \en{by any pair of indices}\ru{по любой паре индексов},
\en{that is}\ru{то~есть}\en{,}
\en{it}\ru{он}
\en{is completely}\ru{полностью}

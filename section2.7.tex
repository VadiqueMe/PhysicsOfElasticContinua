...
\en{reference system}\ru{системы отсчёта}%
   ...
   \item ${\widetilde{\bm{e}}_i \hspace{-0.1ex} = \mathcircabove{\bm{e}}_i}$
   \item
${\bm{e}_i}$\en{ is}\ru{\:---}
...
\en{and}\ru{а}~%
${\widetilde{\bm{x}} = \mathcircabove{\bm{x}} = x_i \hspace{.1ex} \mathcircabove{\bm{e}}_i}$\en{ are}\ru{\:---}
...
\en{is completely determined}\ru{полностью определяется}
\en{by the~two functions}\ru{двумя функциями},
${\positionofthepole(t)}$
\en{and}\ru{и}~${\rotationtensor(t)}$

\nopagebreak\vspace{-0.6em}
\begin{equation}\label{completelyrigidbody.locationvectorofanypoint}
...
\en{For}\ru{Для}
\en{a~non-deformable rigid body}\ru{недеформируемого жёсткого тела},
...
.... \eqref{completelyrigidbody.locationvectorofanypoint} ${\Rightarrow}$

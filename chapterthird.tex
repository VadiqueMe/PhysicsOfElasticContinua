...
= G^{\hspace{.1ex}i\hspace{-0.1ex}j} \hspace{-0.2ex} \currentlocationvector_\differentialindex{i} \currentlocationvector_\differentialindex{\hspace{-0.1ex}j} %%= \hfill }
\\[-0.2em]
...
= U_1 U_2 \hspace{-0.2ex} + U_1 U_3 \hspace{-0.2ex} + U_2 \hspace{.2ex} U_3
\hspace{.1ex} ,
\\
\mathrm{III}\hspace{.16ex}(\bm{U}) \hspace{-0.2ex}
= \mathrm{III}\hspace{.16ex}(\bm{V}) \hspace{-0.2ex}
= U_1 U_2 \hspace{.2ex} U_3
\hspace{.1ex} .
\end{gather*}

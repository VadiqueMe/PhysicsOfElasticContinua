...
\footnote{%
\href{https://en.wikipedia.org/wiki/George_Green_(mathematician)}{\bibauthor{Green, George}}.
...
\en{the stretch tensors}\ru{тензоры искажений}
$\bm{U}\hspace{-0.1em}$
...
\begin{gather*}
\firstcharacteristicinvariantof{\bm{U}}
= \firstcharacteristicinvariantof{\bm{V}}
= \trace{\bm{U}}
= \trace{\bm{V}}
= \textstyle\sum \hspace{-0.2ex} U_{\hspace{-0.2ex}aa}
= \textstyle\sum \hspace{-0.2ex} V_{\hspace{-0.4ex}aa}
= \textstyle\sum \hspace{-0.2ex} j_{\hspace{-0.1ex}k}
\hspace{.1ex} ,
\\
%
\secondcharacteristicinvariantof{\bm{U}} \hspace{-0.2ex}
= \secondcharacteristicinvariantof{\bm{V}} \hspace{-0.2ex}
= j_1 j_2 \hspace{-0.2ex}
+ j_1 j_3 \hspace{-0.2ex}
+ j_2 \hspace{.2ex} j_3
\hspace{.1ex} ,
\\
%
\thirdcharacteristicinvariantof{\bm{U}} \hspace{-0.2ex}
= \thirdcharacteristicinvariantof{\bm{V} \hspace{-0.2ex}
...
For adiabatic processes, ${\potential}$ is equal to the change in internal energy per unit of volume.

For isothermal processes, ${\potential}$ is equal to the Helmholtz free energy per unit of volume.
...
Функция~${\potential\hspace{.12ex}(\anyfirstinvariant, \anysecondinvariant, \anythirdinvariant)}$
для такого материала
бывает весьма сложной%
\footnote{\bibauthor{Harold Alexander}. \href{https://kundoc.com/pdf-a-constitutive-relation-for-rubber-like-materials-.html}{A~constitutive relation for rubber-like ma\-te\-ri\-als~// International Journal of~Engineering Science, volume~6 (September 1968), pages 549\hbox{--}563.}}\hbox{\hspace{-0.5ex}.}
...
${\potential \hspace{-0.4ex} = \hspace{-0.33ex} \potential(\anyfirstinvariant, \anysecondinvariant)}$

Mooney\hbox{--}Rivlin model of incompressible material
\[
\potential = c_1 \bigl( \anyfirstinvariant - 3 \bigr) + c_2 \bigl( \anysecondinvariant - 3 \bigr)
\]
...
c_2 \hspace{-0.16ex} = 0
\;\;\Rightarrow\;\;
\potential = c_1 \bigl( \anyfirstinvariant - 3 \bigr)
\]

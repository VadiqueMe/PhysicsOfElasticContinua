...
\hspace{-0.2ex} \Bigr)^{\hspace{-0.1ex} \timederivativedot}
}
\end{multline*}
...
\displaystyle\left( \integral\displaylimits_{\mathcal{V}} \hspace{-0.3ex} \massdensity \hspace{.2ex} \bm{v} \hspace{.1ex} d\mathcal{V} \hspace{-0.2ex} \right)^{\hspace{-0.25em}\timederivativedot}
=
...
\displaystyle\left( \integral\displaylimits_{\mathcal{V}} \hspace{-0.3ex} \currentlocationvector \times \hspace{-0.2ex} \massdensity \hspace{.2ex} \bm{v} \hspace{0.1ex} d\mathcal{V} \hspace{-0.25ex} \right)^{\hspace{-0.25em} \timederivativedot}
...
(${\bm{v} \equiv \hspace{-0.1ex} \mathdotabove{\currentlocationvector}\hspace{.2ex}}$)

\nopagebreak\vspace{-0.2em}\begin{equation*}
\displaystyle\left( \integral\displaylimits_{\mathcal{V}} \hspace{-0.4ex} \currentlocationvector \times \hspace{-0.2ex} \massdensity \hspace{.1ex} \mathdotabove{\currentlocationvector} \hspace{.4ex} d\mathcal{V} \hspace{-0.2ex} \right)^{\hspace{-0.25em} \timederivativedot}
=

...
\en{into symmetric and skew\hbox{-}symmetric parts}\ru{на симметричную и~кососимметричную части}~(\chapterdotsectionref{chapter:mathapparatus}{section:tensors.symmetric+skewsymmetric})
...
\en{translational degrees of~freedom}\ru{трансляционными степенями свободы}%
\footnote{%
...
\en{about existence}\ru{о~существовании}
...
\noindent
Начальная конфигурация считается естественной (natural configuration)\:--- недеформированной ненапряжённой: ${\bm{C} = \hspace{-0.1ex} {^2\bm{0}} \hspace{.4ex} \Leftrightarrow \hspace{.2ex} \cauchystress = \hspace{-0.2ex} {^2\bm{0}}}$, поэтому в~$\potentialenergydensity$ нет линейных членов.

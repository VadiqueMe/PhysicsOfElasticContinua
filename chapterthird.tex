...
\en{If}\ru{Если} ${\variation{\bm{R}} = \varvector{o} \hspace{-0.2ex} \times \hspace{-0.2ex} \bm{R}}$ (\en{just rotation}\ru{лишь поворот}) \en{with}\ru{с}~${\varvector{\bm{o}} \hspace{-0.1ex} = \boldconst}$, \en{then}\ru{то}

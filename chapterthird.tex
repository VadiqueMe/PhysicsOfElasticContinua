...
\en{And the following}\ru{А~следующие}
...
\\[.5em]
%
\variation{\hspace{.1ex}\bm{C}} = \bm{F}^{\hspace{.1ex}\T} \hspace{-0.3ex} \dotp \hspace{.1ex} \infinimentpetitedeformationvariation \dotp \bm{F} ,
\:\,

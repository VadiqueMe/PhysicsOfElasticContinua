...
\integral\displaylimits_{\mathcal{V}} \hspace{-0.4ex} \left(^{\mathstrut} \hspace{-0.1ex} \rho \bm{f} \dotp \variation{\bm{R}} \hspace{.16ex} + \variation{\internalwork} \right) \hspace{-0.3ex} d\mathcal{V}
...
\vspace{-0.1em} \en{Assuming}\ru{Полагая} ${\varvector{\bm{o}} \hspace{-0.1ex} = \bm{0}}$, ${\variation{\bm{R}} = \boldconst}$ (\en{just translation}\ru{лишь трансляция}) ${\Rightarrow}$~${\boldnabla \hspace{.1ex} \variation{\bm{R}} = \hspace{-0.12ex} {^2\bm{0}}}$,
...
\vspace{-0.5em} \noindent ??? \en{and}\ru{и} ??? ${\cauchystress \dotdotp \hspace{-0.12ex} \boldnabla \hspace{.1ex} \variation{\bm{R}}^{\hspace{.1ex}\T} \hspace{-0.32ex} = 0}$ ???

\en{If}\ru{Если} ${\variation{\bm{R}} = \varvector{o} \hspace{-0.2ex} \times \hspace{-0.2ex} \bm{R}}$ (\en{just rotation}\ru{лишь поворот}), \en{then}\ru{то}
...
= \hspace{-0.2ex} - \bm{E} \hspace{-0.16ex} \times \hspace{-0.2ex} \varvector{o}
\end{equation*}
...
Изложенному в~\pararef{para:virtualworkprinciple.elastic} применению принципа виртуальной работы предшествовало введение тензора напряжения Коши через баланс сил для элементарного тетраэдра~(\pararef{para:stressviatetrahedron}). Но~здесь мы увидим, что принцип даёт обойтись и без рассуждений с~тетраэдром.
...
\ru{\vspace{-0.25em} \noindent --- формально введённый симметричный множитель~${\hspace{-0.16ex} ^2\hspace{-0.2ex}\bm{\lambda}}$ оказался тензором напряжения Коши.}

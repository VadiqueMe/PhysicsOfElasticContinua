...
\en{of the unit}\ru{единичного}
(\en{metric}\ru{метрического})
...
\vspace{-0.2em}\noindent
\en{but}\ru{но}
\en{these components are}\ru{эти компоненты}
\en{in the different bases}\ru{в~разных базисах}.
\en{Using the index notation}\ru{Пользуясь индексной записью},
\en{it’s easy to get confused}\ru{легко запутаться}
\en{in the differences}\ru{в~различиях}
\en{between}\ru{между}
\en{the~unit}\ru{единичным} \en{tensor}\ru{тензором}~$\UnitDyad$
\en{and the~strain tensors}\ru{и~тензорами деформации}
$\bm{G}$, $\mathboldPhi$, ${{^2}\hspace{-0.4ex}\bm{f}\hspace{-0.1ex}}$, ${{^2}\hspace{-0.2ex}\bm{c}}$.

\en{The direct indexless notation}\ru{Прямая безиндексная запись}
\en{has}\ru{имеет}
en{here}\ru{здесь}
\en{the obvious}\ru{явное}
\en{advantage}\ru{преимущество}.

\en{As was mentioned}\ru{Как упоминалось}
\en{in}\ru{в}~\chapdotpararef{chapter:mathapparatus}{para:polardecomposition},
\en{the stretch tensors}\ru{тензоры искажений} $\bm{U}\hspace{-0.1em}$ \en{and}\ru{и}~$\bm{V}\hspace{-0.1em}$
\en{have}\ru{имеют}
\en{the same invariants}\ru{одинаковые инварианты}.
\en{If}\ru{Если}
$U_{\hspace{-0.2ex}k}$ (${k \hspace{-.2ex} = \hspace{-.2ex} 1, 2, 3})$
\en{are}\ru{это}
\en{the eigenvalues}\ru{собственные значения}
\en{of~}\en{the stretch tensors}\ru{тензоров искажений}
${\bm{U}\hspace{-0.1em}}$ \en{and}\ru{и}~${\bm{V}\hspace{-0.2em}}$,
\en{then}\ru{то}
\en{the invariants will be}\ru{инвариантами будут}

...
\vspace{-0.1em} \en{Assuming}\ru{Полагая} ${\varvector{\bm{o}} \hspace{-0.1ex} = \bm{0}}$, ${\variation{\bm{R}} = \boldconst}$ (\en{just translation}\ru{лишь трансляция}) ${\Rightarrow}$~${\hspace{-0.2ex}\boldnabla \hspace{.1ex} \variation{\bm{R}} = \hspace{-0.12ex} {^2\bm{0}}}$,
...
\vspace{-0.5em} \noindent ??? \en{and}\ru{и} ??? ${\cauchystress \dotdotp \hspace{-0.12ex} \boldnabla \hspace{.1ex} \variation{\bm{R}}^{\hspace{.16ex}\T} \hspace{-0.32ex} = 0}$ ???

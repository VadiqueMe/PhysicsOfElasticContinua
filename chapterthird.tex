...
\en{Components}\ru{Компоненты} \en{of the deformation tensors}\ru{тензоров деформации}
...
\en{As was mentioned in}\ru{Как упоминалось в}~\chapdotpararef{chapter:elementsoftensorcalculus}{para:polardecomposition}, \en{the stretch tensors}\ru{тензоры искажений} $\bm{U}\hspace{-0.1em}$ \en{and}\ru{и}~$\bm{V}\hspace{-0.1em}$ \en{have}\ru{имеют} \en{common invariants}\ru{общие инварианты}.
...
\]
\en{where}\ru{где}~$\bm{F}$ is the motion gradient and~${J \equiv \operatorname{det} \bm{F}}$ is \en{the Jacobian determinant}\ru{определитель Якоби}.

...
\en{makes no sense}\ru{не~имеет смысла}.}%
...
\en{For}\ru{Для}
\en{the~dyadic multiplication}\ru{диадного умножения}
...
\en{by a~large dot}\ru{крупной точкой}~\hbox{\hspace{-0.2ex}\inquotes{${\dotp\hspace{.22ex}}$}\hspace{-0.2ex}},
\en{which}\ru{которая}
\en{shows}\ru{показывает}
...
\en{it is neutral}\ru{он нейтрален}
...
\en{In the}\ru{В}~\textcolor{magenta}{\en{commutative}\ru{коммутативном}}
...
\en{how to swap}\ru{как поменять местами}
\en{multipliers}\ru{множители}
\en{for}\ru{для}
\en{the }\hbox{\hspace{-0.2ex}\inquotes{${\dotp\hspace{.22ex}}$}\hspace{-0.2ex}-\en{product}\ru{произведения}}~%
(dot product\ru{’а})
\en{of two}\ru{двух}
...
%%\noindent
\en{For two dyads}\ru{Для двух диад}
${\bm{B} \hspace{-0.1ex} = \bm{b}\bm{d}}$ \en{and}\ru{и}~${\bm{Q} \hspace{-0.1ex} = \bm{p}\bm{q}}$

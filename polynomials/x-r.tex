...
\textsc{Lemma}.
{\itshape
For any integer $n \cge 1$, the difference of two $n$-th powers, ${x^n \! - c^n\hspace{-0.2ex}}$,
...
\vspace{-0.75em}
\noindent
--- the latter exhibits the intended representation with ${\mathcal{R} = P(r) \in \domain \hspace{.2ex}}$.
...
\vspace{-0.25em}
\begin{equation*}
P(x) = (x-r) \hspace{.2ex} Q\sprime(x) + R\sprime
\quad \text{and} \quad
P(x) = (x-r) \hspace{.2ex} Q\dprime(x) + R\dprime
.
\vspace{-0.2em}
\end{equation*}
%
...
\vspace{-0.25em}
\begin{equation*}
(x-r) \hspace{.2ex} Q\sprime(x) + R\sprime
- (x-r) \hspace{.2ex} Q\dprime(x) - R\dprime
= 0
\hspace{.2ex} ,
\vspace{-0.25em}
\end{equation*}
...
\vspace{-0.5em}
\begin{equation*}
(x-r) \bigl( Q\sprime(x) \hspace{-0.2ex} - Q\dprime(x) \bigr) \hspace{-0.2ex}
= R\dprime \hspace{-0.2ex} - R\sprime
.
\end{equation*}
...
the~difference~${R\dprime \hspace{-0.2ex} - R\sprime}$ is an~element of~$\domain$ itself\:---
equivalently, a~constant polynomial in~$\polynomialring{x}$.
Accordingly, once evaluation at~${x \ceq r}$ yields
${0 = R\dprime \hspace{-0.2ex} - R\sprime}$,
...
\vspace{-0.25em}
\begin{equation*}
(x - r) \bigl(Q\sprime(x) \hspace{-0.2ex} - Q\dprime(x)\bigr) \hspace{-0.2ex} = 0
\hspace{.2ex} .
\end{equation*}
...
${Q\sprime(x) \hspace{-0.2ex} - Q\dprime(x)}$
is the zero polynomial,
the absence of zero divisors in~$\polynomialring{x}$
implies that
%
\begin{equation*}
Q\sprime(x) \hspace{-0.2ex} - Q\dprime(x) \hspace{-0.1ex} = 0
\hspace{.2ex} ,
\end{equation*}
%
\vspace{-1.75em}
...
&&
Q\sprime(x) \hspace{-0.1ex} = Q\dprime(x)
\hspace{.1ex} .
&&
\end{flalign*}
...
\vspace{-1.75em}
\begin{flalign*}
\makebox[0pt][l]{\hspace{\parindent}\text{Thus}}
&&
...
Equivalently, ${r}$ is a~solution of the polynomial equation ${P(x) \hspace{-0.2ex} = 0}$.
}
...
\textsc{Corollary}.
{\itshape
If ${r \cin \domain}$ is a~root~(solution) of the polynomial equation ${P(x) \hspace{-0.2ex} = 0}$,
...
For instance, ${x^2 - 2 = 0}$ has no root in~$\mathbb{Q}$ but has the~roots ${\pm \sqrt{2}}$ in~$\mathbb{R}$.

...
%
\begin{equation*}
P \Bigl( \smalldisplaystyleonehalf \Bigr) \nfex = 0
\fex ,
\end{equation*}
%
...
%
\begin{equation*}
\smalldisplaystyleonehalf,\quad \sqrt{2},\quad -\sqrt{2}
\thex .
\end{equation*}

\vspace{-0.5em}
This example illustrates a~phenomenon\::
a~polynomial may fail to have roots in its original coefficient domain,
...
= \bigl\{\, a + b\sqrt{2} \hspace{1ex} \big|\; a,b \in \mathbb{Q} \,\bigr\}
\thex .
\end{equation*}
%
...
\begin{minipage}{\dimexpr(\linewidth)/8*10\relax}
\indentpar
What emerges here is a~central idea of advanced algebra\:---

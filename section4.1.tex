...
${\hspace{.1ex} \volumeloadvector \hspace{-0.3ex} = \hspace{-0.3ex} \rho \hspace{-0.1ex} \massloadvector}$),
\en{because}\ru{потому что}
${d \mathcal{V} \hspace{-0.2ex} = d \mathcircabove{\mathcal{V}}}$,
${\rho \hspace{.2ex} d \mathcal{V} \hspace{-0.1ex} = \hspace{-0.2ex} \mathcircabove{\rho} \hspace{.2ex} d \mathcircabove{\mathcal{V}}}$
\en{and}\ru{и}~%
${
\hspace{-0.2ex} \massloadvector \hspace{-0.1ex} dm
= \hspace{-0.1ex}
\massloadvector \hspace{-0.2ex} \mathcircabove{\rho} \hspace{.2ex} d \mathcircabove{\mathcal{V}}
\hspace{-0.2ex} = \hspace{-0.1ex}
\massloadvector \hspace{-0.3ex} \rho \hspace{.2ex} d \mathcal{V}
\hspace{-0.1ex} =
...
\hspace{.1ex} + \hspace{.1ex}
\rho \hspace{.25ex} \variation{\hspace{-0.2ex}\massloadvector}
= \hspace{.1ex}
\zerovector
\hspace{.11ex} .
\end{array}
...
\item
   ...
   $\infinitesimaldeformation$,
\item
   ${\variation{\hspace{.1ex}\firstpiolakirchhoffstress} \narroweq \hspace{.1ex} \varbivalent{\hspace{-0.15ex}\cauchystress}}$
   \hbox{\hspace{.25ex}\en{to}\ru{на}\hspace{.25ex}}
   $\linearstress$,
\item ${%
   \scalebox{.95}{$%
...
\en{also includes}\ru{включает также}
\en{the~inertial addend}\ru{инерционную добавку}
${ - \hspace{.2ex} \rho \hspace{.2ex} \mathdotdotabove{\bm{u}} }$.
%

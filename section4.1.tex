...
\en{the~inertial addend}\ru{инерционное слагаемое}~${ - \hspace{.2ex} \rho \hspace{.2ex} \mathdotdotabove{\bm{u}} }$.
\en{And }\ru{А~}%
...
\en{at the specific}\ru{в~определенный}
\en{moment of~time}\ru{момент времени}~${t \narroweq \hspace{.1ex} 0}$.

...
\item \en{absolute deformation}\ru{абсолютная деформация} ${\bm{u} \hspace{.2ex} \mapsto \infinitesimaldeformation}$ \en{relative deformation}\ru{относительная деформация},
\end{itemize}
...
\en{of displacement~(absolute deformation)}\ru{смещения~(абсолютной деформации)},

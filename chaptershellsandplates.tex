...
\dropcap{\en{A}\ru{П}}{\en{~surface}\ru{оверхность}}
...
не~так~уж тяжело
to figure out
\en{the mechanics}\ru{в~механике}
\en{of~shells}\ru{оболочек}.
...
оп\'{и}сана трёхмерная постановка).
...
Это вторая из~двух задач, о~которых говорилось в~\sectionref{para:overviewofplates}.
Силы

...
\hspace{-0.4ex} \Bigl( \hspace{-0.1ex} \kineticenergydensity + \potentialenergydensity \Bigr)^{\hspace{-0.2ex} \timederivativedot} d\mathcal{V}
= \hspace{-0.2ex}
...
\begin{array}{c}
\mathdotabove{\kineticenergydensity} = \smalldisplaystyleonehalf \bigl( \hspace{.1ex} \rho \hspace{.2ex} \mathdotabove{\bm{u}} \dotp \mathdotabove{\bm{u}} \hspace{.1ex} \bigr)^{\timederivativedot} \hspace{-0.1ex}
...
\en{lack}\ru{лишены}
\en{the~}\inquotesx{\en{mathematical scrupulosity}\ru{математической щепетильности}}[.]
\en{If}\ru{Если}
\en{the~reader}\ru{читатель}
\en{is looking for}\ru{ищет}
\en{such}\ru{таковую},
\en{there is}\ru{то есть},
\en{for example}\ru{для примера},
\en{the~monograph}\ru{монография}
\en{by~}Philippe\ru{’а} Ciarlet~\cite{ciarlet-mathematicalelasticity}.

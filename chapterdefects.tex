...
\label{section:volterradislocations}
...
\en{As shown in}\ru{Как показано в}~\chapterdotsectionref{chapter:linearclassicalelasticity}{section:displacementsfromdeformations}, \en{the equation of compatibility of deformations}\ru{уравнение совместности деформаций}
...
\label{section:rectilineardislocations}
...
\en{The~theory of eigen-stresses}\ru{Теория собственных напряжений}~(eigen\-spannung\-en)
\en{is explained}\ru{объясняется}
\en{by }Ekkehart\ru{’ом} Kröner\ru{’ом}
\en{in}\ru{в}~\cite{kroener-kontinuumstheorie}.
\en{Calculation of stresses}\ru{Расчёт напряжений}
\en{when winding a~coil}\ru{при намотке катушки}
\en{is described}\ru{описан}
\en{by }Richard Southwell\ru{’ом}
\en{in his book}\ru{в~своей книге}~\cite{southwell-introductiontotheoryofelasticity}.

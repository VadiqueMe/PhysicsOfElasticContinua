...
\en{the variation}\ru{варьирования}
\en{of the displacements}\ru{перемещений},
...
\noindent
\en{The formulation}\ru{Формулировка} \en{of~the~principle}\ru{принципа}:
...
\en{when}\ru{тогда, когда} \en{the displacements}\ru{перемещения}~$\bm{u}$
...
\en{of~displacements}\ru{перемещений}~$\bm{u}$,
...
\en{Taking}\ru{Взяв}
\en{the some other}\ru{какое\hbox{-}то другое} \en{satisfactory}\ru{приемлемое}
\en{field of~displacements}\ru{поле перемещений}~${\bm{u}'\hspace{-0.25ex}}$,
\en{have a~look at}\ru{взгл\'{я}нем на}

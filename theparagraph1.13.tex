...
\vspace{.1em}\noindent
Произведение определителей~${\permutationsparity_{i\hspace{-0.1ex}j\hspace{-0.1ex}k} \permutationsparity_{pqr}}$ равно определителю произведения матриц, \en{and}\ru{а}~\en{elements of~the~latter}\ru{элементы последнего}\ru{\:---}\en{ are} \en{sums}\ru{суммы} \en{like}\ru{вида}

...
(begin copied from \chapdotpararef{chapter:elementsoftensorcalculus}{para:calculusofvariations})
...
(end of copied from \chapdotpararef{chapter:elementsoftensorcalculus}{para:calculusofvariations})
...
Интересен курс Ф.\,Р.\;Гантмахера~\cite{gantmacher} с~компактным, но~полным изложением осн\'{о}в.

...
\en{the~double}\ru{удвоенной}\footnote{%
...
\en{of the~energy of~deformation}\ru{энергии деформации}
...
\tikzmark{beginMinusLoad} \boldnabla \dotp \linearstress \tikzmark{endMinusLoad} \dotp \bm{u}
%%\;\Rightarrow
\\[.5em]
%
\Rightarrow\;\,
...
\en{also follows}\ru{следует также}\ru{,}
\en{that}\ru{что}
\en{without loading}\ru{без нагрузки}
${\hspace{-0.25ex}
...
\en{both the~stress}\ru{то~и~напряжение}~$\linearstress$\ru{,}
\en{and }\ru{и~}\en{the~deformation}\ru{деформация}~$\infinitesimaldeformation$
...
\en{by~}\href{https://en.wikipedia.org/wiki/Gustav_Kirchhoff}{Gustav\ru{’ом} Kirchhoff\ru{’ом}}
...
\en{the~nonlinearity}\ru{нелинейности}
\en{of this problem}\ru{этой задачи}.
%
\en{If the~load}\ru{Если нагрузка}
...
\nicefootnotetext{auxfootnotecounter}{\bookauthor{Gustav Robert Kirchhoff}.
\href{https://opacplus.bsb-muenchen.de/Vta2/bsb10525510/bsb:2960444?page=291}{Über das~Gleich\-gewicht und die~Bewe\-gung eines unendlich dünnen elastischen Stabes.
\emph{Journal für die reine und angewandte Mathematik (Crelle’s journal)}, 56.\:Band (1859).
Seiten 285\hbox{--}313.} (Seite 291)}

...
\en{anisotropic materials}\ru{анизотропных материалов}
...
\en{isotropic ones}\ru{и~изотропные}\:---
\en{materials}\ru{материалы}\ru{,}
\en{whose properties}\ru{свойства которых}
\en{remain}\ru{остаются}
\en{the~same}\ru{одинаковыми}
\en{in any}\ru{в~любом}
\en{direction}\ru{направлении}.
...
\en{here}\ru{здесь},
\en{for}\ru{для}
\en{an~isotropic}\ru{изотропной}
\en{linear elastic}\ru{линейно упругой}
...
\en{as}\ru{как}
\en{an~isotropic function}\ru{изотропную функцию}\ru{,}
\en{depending}\ru{зависящую}
\en{only}\ru{только}
\en{on the~invariants}\ru{от инвариантов}\footnote{%
\en{Any func\-tion}\ru{Любая функция}\ru{,}
\en{whose arguments are}\ru{аргументы которой\:---}
\en{only}\ru{только}
\en{invariants}\ru{инварианты}\ru{,}
\en{is isotropic}\ru{изотропна}.}

\nopagebreak\vspace{-0.5em}
\begin{equation}
\potentialenergydensity(\infinitesimaldeformation) \hspace{-0.2ex}
= \potentialenergydensity \bigl( \hspace{.1ex}
     \anyfirstinvariant(\infinitesimaldeformation),
     \anysecondinvariant(\infinitesimaldeformation) \bigr) \hspace{-0.3ex}
...
$\anysecondinvariant$
\en{is not}\ru{это не}
\en{coefficient}\ru{коэффициент}~$\secondcharacteristicinvariant$
...
\en{the~second degree}\ru{второй степени}.
...
\begin{equation*}
\linearstress =
\thefirstlameparameter \hspace{.2ex} \infinitesimaldeformation \hspace{-0.2ex} \dotdotp \hspace{-0.3ex} \UnitDyad \hspace{-0.1ex} \UnitDyad

...
\en{of~these forces}\ru{этих сил}~(\inquotesx{\en{statically frozen}\ru{статически замороженных}}[---] \en{constant along time}\ru{постоянных во~времени})
...
\en{The work}\ru{Работа}
\en{of the external forces}\ru{внешних сил}
\en{on the actual displacements}\ru{на актуальных перемещениях}
\ru{равна}\en{is equal to}
\en{twice}\ru{удвоенному}
\en{the elastic potential}\ru{упругому потенциалу}
$2\potential$.
...
\en{is}\ru{это}
\en{the }\inquotes{
   \en{additional energy}\ru{дополнительная энергия}
}.
\en{It is lost}\ru{Она теряется}
\en{до}\ru{before}
...
\en{So is in the theory.}\ru{Так в~теории.}

\en{But}\ru{Но}
\en{any real loading}\ru{любое реальное нагружение}
\en{would be}\ru{не будет}
\en{neither sudden loading}\ru{ни внезапным нагружением}\ru{,}
\en{nor infinitely slow loading}\ru{ни бесконечно медленным}.
%\ru{ нагружением}.
\en{These are two extremes}\ru{Это две крайности}.
...
\en{не похожей на теорию}\ru{different from the theory}.

%(there’s always heating due to the dissipation of the energy)

\ru{В~области~же}\en{In the area}
\en{of the infinitesimal variations}\ru{бесконечномалых вариаций}
\en{here}\ru{здесь}
\en{the real external forces}\ru{реальные внешние силы},
\en{applied to the medium}\ru{приложенные к~среде},
\en{work}\ru{работают}
\en{on virtual displacements}\ru{на виртуальных перемещениях}
\en{and}\ru{и}
\en{produce the work}\ru{производят работу},
\en{which}\ru{которая}
\en{is exactly equal}\ru{в~точности равна}
\en{to the variation}\ru{вариации}
\en{of the elastic potential}\inquotes{упругого потенциала}.
...
\en{when}\ru{когда}
\ru{варьируются }\en{the only displacements}\ru{только перемещения}\en{ vary}
...
(\en{not varied here}\ru{здесь не варьируемых})
\en{on variations}\ru{на~вариациях}
\en{of displacements}\ru{перемещений}
\en{would be equal to}\ru{была бы равна}
...
\en{the variation}\ru{вариации}
%%\en{of the elastic potential}\ru{упругого потенциала}
\en{of the internal energy}\ru{внутренней энергии}
).
...
\en{with a~longitudinal force}\ru{продольной силой}~(\figref{fig:deformedrod}).
\en{When}\ru{Когда}

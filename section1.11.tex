...
\en{the~matrix of~cosines}\ru{матрицу косинусов}~${\cosinematrix{\!j\mathcircabove{i}} = \hspace{.1ex} \mathcircabove{\bm{e}}_i \dotp \bm{e}_j}$
...
${\mathcircabove{\bm{C}} = C_{i\hspace{-0.1ex}j} \hspace{.1ex} \mathcircabove{\bm{e}}_i \mathcircabove{\bm{e}}_j}$\en{,}
\en{a~rotation}\ru{поворот}
\en{into the current position}\ru{в~текущую позицию}
${\bm{C} = C_{i\hspace{-0.1ex}j} \hspace{.1ex} \bm{e}_i \bm{e}_j}$
...
= \mathdotabove{\bm{e}}_i \mathcircabove{\bm{e}}_i \hspace{-0.2ex}}$
(\en{since}\ru{ведь}
...
\nopagebreak\vspace{-0.1em}\begin{equation*}
\mathdotabove{\rotationtensor} \dotp \rotationtensor^{\T} \hspace{-0.1ex} + \hspace{.25ex} \rotationtensor \dotp \mathdotabove{\rotationtensor}^{\T}
...
${\left({ \mathdotabove{\rotationtensor} \dotp \rotationtensor^{\T} }\right)^{\raisemath{-0.25em}{\!\T}} \hspace{-0.4ex} = \rotationtensor \dotp \mathdotabove{\rotationtensor}^{\T}}$\hspace{-0.4ex},
\en{therefore}\ru{поэтому}
\en{tensor}\ru{тензор}~${\mathdotabove{\rotationtensor} \dotp \rotationtensor^{\T\!}}$
\en{happens to~be}\ru{оказывается}
...
\en{as}\ru{как}
${\mathdotabove{\rotationtensor} \dotp \rotationtensor^{\T} \hspace{-0.4ex}
= \bm{\omega} \times \UnitDyad
= \bm{\omega} \times \rotationtensor \dotp \rotationtensor^{\T}}$
\hspace{-0.4ex} .
%
...
\en{for}\ru{для}
\en{the~}(\en{pseudo}\ru{псевдо})\en{vector}\ru{вектора}~${\bm{\omega}}$,

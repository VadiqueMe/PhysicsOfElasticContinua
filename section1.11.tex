...
${\left(\determinant \orthogonaltensor\hspace{.1ex}\right)^2 \hspace{-0.1ex} = 1}$:
...
\en{via}\ru{через}
\en{two parameters}\ru{два параметра}
\en{of~the~finite rotation}\ru{конечного поворота}.

...
\en{syngony}\ru{сингония}
$=$
\en{lattice system}\ru{система решёток}
$=$
\en{crystallographic system}\ru{кристаллографическая система}
$=$
\en{crystal symmetry}\ru{симметрия кристаллов}
}\hbox{\hspace{-0.5ex},}

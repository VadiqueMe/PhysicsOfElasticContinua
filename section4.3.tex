...
= \trace{\withtheindexofperpendicularity{\infinitesimaldeformation}}
\hspace{.1ex} , \hspace{.5em}
...
\begin{equation}\label{Hooke.for-symmetric-crystals}
   ...
   \Bigl( \stiffnesstensor \dotdotp \infinitesimaldeformation \Bigr)
   \dotp
   \orthogonaltensor^\T
   \hspace{1.5em} \forall \hspace{.3ex} \infinitesimaldeformation .
\end{equation}

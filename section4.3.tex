...
\eqrefwithchapterdotsection{orthogonalityofrotationtensor}{chapter:mathapparatus}{section:rotationtensor},
...
\nopagebreak\vspace{-0.2em}\begin{equation}\label{legendretransformforlinearelasticenergy}
...
= \displaystyle\frac{\raisemath{-0.2em}{\partial\hspace{.1ex} \widehat{\potentialenergydensity}}}{\raisemath{.04em}{\partial \linearstress}}
= \hspace{-0.1ex} \pliabilitytensor \dotdotp \hspace{-0.1ex} \linearstress
\hspace{.1ex} ,
\hspace{.8em}
\widehat{\potentialenergydensity}(\hspace{-0.1ex} \linearstress \hspace{.1ex}) \hspace{-0.1ex}
...
\inquotes{\en{complementary energy}\ru{добавочная энергия}}
${\widehat{\potentialenergydensity} = \potentialenergydensity = \smalldisplaystyleonehalf \hspace{.2ex} \linearstress \dotdotp \infinitesimaldeformation}$

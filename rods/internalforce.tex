...
\draw [ beam line, fill=\beamcolor ] ( \reflength, 0 ) circle ( 1.2pt ) ;
...
\draw [ external force ]
	($ ( \reflength, 0 ) + ( \externalforcelength, 0 ) $) -- ++( -\externalforcelength, 0 )  ;
...
\pgfmathsetmacro\zfrom{\reflength}
...
\draw [ beam line, color=\beamcolor, fill=\beamcolor ] ( \reflength, 0 ) circle ( 1.2pt ) ;
...
\draw [ external force ]
	( \reflength, 0 ) -- ++( \externalforcelength, 0 )  ;

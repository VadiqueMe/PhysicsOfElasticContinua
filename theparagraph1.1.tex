...
В~разных базисах компоненты одного и~того~же вектора будут разные.}
\par}

\en{Here it is}\ru{Вот он}\:--- \en{the }\en{vector}\ru{вектор},
$\bm{v}$ \en{looks}\ru{выглядит} \en{like a~suitable name}\ru{подходящим именем} \en{for it}\ru{для него}.

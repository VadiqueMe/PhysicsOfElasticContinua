...
%%\def\quartercircle{90\degree\hspace{-0.2ex}}
%%\def\zerodegrees{0\degree\hspace{-0.2ex}}
\def\quartercircle{\verynicefrac{\pi\hspace{-0.2ex}}{2}}
\def\zerodegrees{0}

\vspace{-1em}\[
\scalebox{.8}[.85]{$\left[ \begin{array}{ccc}
\mathcircabove{\bm{e}}_1 \dotp \bm{e}_1 & \mathcircabove{\bm{e}}_1 \dotp \bm{e}_2 & \mathcircabove{\bm{e}}_1 \dotp \bm{e}_3 \\
\mathcircabove{\bm{e}}_2 \dotp \bm{e}_1 & \mathcircabove{\bm{e}}_2 \dotp \bm{e}_2 & \mathcircabove{\bm{e}}_2 \dotp \bm{e}_3 \\
\mathcircabove{\bm{e}}_3 \dotp \bm{e}_1 & \mathcircabove{\bm{e}}_3 \dotp \bm{e}_2 & \mathcircabove{\bm{e}}_3 \dotp \bm{e}_3
\end{array} \right]$} \hspace{-0.32ex} = \hspace{-0.2ex}
%
\scalebox{.8}[.85]{$\left[ \hspace{-0.2ex} \begin{array}{ccc}
\cosine \vartheta & \hspace{-1ex} \cosine \left( \quartercircle \hspace{-0.4ex} + \hspace{-0.2ex} \vartheta \right) & \cosine \quartercircle \\
\cosine \left( \quartercircle \hspace{-0.4ex} - \hspace{-0.2ex} \vartheta \right) & \cosine \vartheta & \cosine \quartercircle \\
\cosine \quartercircle & \cosine \quartercircle & \cosine \zerodegrees
\end{array} \right]$} \hspace{-0.32ex} = \hspace{-0.2ex}
%
\scalebox{.8}[.85]{$\left[ \hspace{-0.1ex} \begin{array}{ccc}
...
=\\[0.32em]
%
= \bigl( \UnitDyad \cosine \vartheta - \hspace{-0.1ex} \tikzmark{StartBraceKk} {\hspace{.1ex}\bm{e}_3 \bm{e}_3\hspace{.1ex}} \tikzmark{EndBraceKk} \hspace{-0.25ex} \cosine \vartheta \hspace{.2ex} \bigr) \hspace{-0.2ex} + \hspace{-0.2ex} \tikzmark{StartBraceSkewsymmetry} {\bigl( \bm{e}_2 \bm{e}_1 \hspace{-0.2ex} - \bm{e}_1 \bm{e}_2 \bigr)} \tikzmark{EndBraceSkewsymmetry} \sine \vartheta + \bm{k} \bm{k} \hspace{.1ex}
=\\[1.5em]
%
\shoveright{ \hfill = \UnitDyad \cosine \vartheta + \bm{k} \times \hspace{-0.2ex} \UnitDyad \sine \vartheta + \bm{k} \bm{k} \bigl({1 - \cosine \vartheta}\bigr) }
\end{multline*}
...
\AddUnderBrace[line width=0.75pt][-0.1ex,-0.2ex][xshift=.3ex,yshift=.2ex]{StartBraceSkewsymmetry}{EndBraceSkewsymmetry}{${\scriptstyle \bm{e}_3 \times \bm{e}_i \bm{e}_i \:=\: \permutationsparitysymbols{3i\hspace{-0.1ex}j} \bm{e}_j \bm{e}_i}$}

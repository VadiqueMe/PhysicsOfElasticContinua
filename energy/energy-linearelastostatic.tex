...
= \variation{\potential} + \variation{\widehat{\potential}}
\\[.3em]
%
...
\:\:
\variation{\widehat{\potential}} = \variation{\hspace{-0.1ex}\linearstress} \dotdotp \infinitesimaldeformation
...
\begin{tikzpicture}[scale=0.72]
	...
	\draw (0.7 * \epsilonlength, 0.3 * \taulength) circle (0.1)
		...
		{\scalebox{1.5}[1.5]{$\potential$}} ;

	\draw (0.3 * \epsilonlength, 0.7 * \taulength) circle (0.1)
		node [color=black, anchor=center, shape=circle, fill=white, outer sep=5pt, inner sep=2pt]
		{\scalebox{1.5}[1.5]{$\widehat{\potential}$}} ;
...
= \hspace{.1ex}
\potential(\infinitesimaldeformation) \hspace{-0.1ex} + \hspace{.1ex} \widehat{\potential}(\hspace{-0.1ex}\linearstress\hspace{.12ex})
\\[.4em]
%
\potential(\infinitesimaldeformation) \hspace{-0.1ex}

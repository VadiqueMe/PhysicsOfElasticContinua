...
= \variation{\potentialenergydensity} + \variation{\widehat{\potentialenergydensity}}
\\[.3em]
%
...
\:\:
\variation{\widehat{\potentialenergydensity}} = \variation{\hspace{-0.1ex}\linearstress} \dotdotp \infinitesimaldeformation
...
\begin{tikzpicture}[scale=0.72]
	...
	\draw (0.3 * \epsilonlength, 0.7 * \taulength) circle (0.1)
		node [color=black, anchor=center, shape=circle, fill=white, outer sep=5pt, inner sep=2pt]
		{\scalebox{1.5}[1.5]{$\widehat{\potentialenergydensity}$}} ;
...
= \hspace{.1ex}
\potentialenergydensity (\infinitesimaldeformation) \hspace{-0.1ex} + \hspace{.1ex} \widehat{\potentialenergydensity}(\hspace{-0.1ex}\linearstress\hspace{.12ex})
\\[.4em]
%
...
\\[.4em]
%
\widehat{\potentialenergydensity}(\hspace{-0.1ex}\linearstress\hspace{.12ex}) \hspace{-0.1ex}

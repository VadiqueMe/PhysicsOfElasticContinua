...
% calculates dot product of location vectors of two points specified by cartesian coordinates
...
% calculates dot product of location vectors of two points specified by spherical coordinates
...
\vspace{10mm}\caption{\inquotes{\en{Decomposition of vector in oblique basis}\ru{Разложение вектора в косоугольном базисе}}}\label{fig:DecompositionOfVector}

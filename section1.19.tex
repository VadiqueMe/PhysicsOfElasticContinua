...
\noindent
\en{Dealing}\ru{Имея дело}
\en{with tensor fields}\ru{с~тензорными полями}
\en{in curvilinear coordinates}\ru{в~криволинейных координатах}~(\sectionref{section:spatialdifferentiation}),
\en{the~location vector}\ru{вектор положения}~%
(\en{radius vector}\ru{вектор радиуса})
\en{of~a~point}\ru{точки}
\en{was introduced}\ru{был введён}
\en{as a~function}\ru{как функция}~\eqref{locationvectorfromcoordinates}
\en{of these coordinates}\ru{этих координат},
${\locationvector \hspace{-0.4ex} = \hspace{-0.4ex} \locationvector(q^{\hspace{.1ex}i}\hspace{.1ex})}$.
%
\en{From this relation}\ru{Из этого отношения}
\en{originate many others}\ru{происходят многие другие},
\en{such as}\ru{такие как}

\nopagebreak\begin{itemize}
\item
\en{the vectors of local tangent basis}\ru{векторы локального касательного базиса}
${%
\locationvector_\differentialindex{i} \hspace{-0.16ex} \equiv \smash{ \raisemath{.16em}{\scalebox{.8}{$ \partial \hspace{.1ex} \locationvector $}} \hspace{-0.3ex} / \hspace{-0.4ex} \raisemath{-0.32em}{\scalebox{0.8}{$ \partial q^{\hspace{.1ex}i} $}} } \hspace{-0.15ex} \equiv \partial_i \hspace{.1ex} \locationvector%
}$,
%
\item
\en{the components}\ru{компоненты}
${\textsl{g}_{i\hspace{-0.1ex}j} \hspace{-0.24ex} \equiv \locationvector_\differentialindex{i} \hspace{-0.16ex} \dotp \locationvector_\differentialindex{\hspace{-0.1ex}j}}$
\en{and}\ru{и}~${\textsl{g}^{\hspace{.25ex}i\hspace{-0.1ex}j} \hspace{-0.32ex} \equiv \locationvector^i \hspace{-0.32ex} \dotp \locationvector^j \hspace{-0.32ex} = \smash{\textsl{g}_{i\hspace{-0.1ex}j}^{\hspace{.33ex}\expminusone}}}$
\en{of the~unit}\ru{единичного}
(\inquotes{\en{metric}\ru{метрического}})
\en{tensor}\ru{тензора}~${\UnitDyad = \locationvector_\differentialindex{i} \locationvector^i \hspace{-0.2ex} = \locationvector^i \locationvector_\differentialindex{i} \hspace{-0.15ex} = \textsl{g}_{j\hspace{-0.1ex}k} \hspace{.1ex} \locationvector^{\hspace{.1ex}j} \hspace{-0.1ex} \locationvector^{k} \hspace{-0.25ex} = \textsl{g}^{\hspace{.25ex}j\hspace{-0.1ex}k} \hspace{.1ex} \locationvector_\differentialindex{\hspace{-0.1ex}j} \locationvector_\differentialindex{k}}$,
%
\item
\en{the vectors of local dual (reciprocal) cotangent basis}\ru{векторы локального дуального (взаимного) кокасательного базиса}
${\locationvector^i \hspace{-0.32ex} \dotp \locationvector_\differentialindex{\hspace{-0.1ex}j} \hspace{-0.22ex} = \delta_{\hspace{-0.15ex}j}^{\hspace{.2ex}i}}$, ${\locationvector^i \hspace{-0.25ex} = \textsl{g}^{\hspace{.25ex}i\hspace{-0.1ex}j} \locationvector_\differentialindex{\hspace{-0.1ex}j}}$,
%
\item
\en{the differential}\ru{диф\-ферен\-циаль\-ный}
\en{nabla}\ru{набла}\hbox{-}\en{operator}\ru{оператор}
(\ru{оператор }Hamilton’\en{s}\ru{а}\en{ operator}, Hamiltonian)
${\smash{\boldnabla \equiv \locationvector^i \partial_i}}$,
${\UnitDyad = \hspace{-0.25ex} \smash{\boldnabla \locationvector}}$,
%
\item
\en{the full differential}\ru{полный дифференциал}
${d \bm{\xi} = d \locationvector \dotp \hspace{-0.2ex} \boldnabla \hspace{-0.05ex} \bm{\xi} \hspace{.1ex}}$,
%
\item
\en{the partial derivatives}\ru{частные производные}
\en{of tangent basis vectors}\ru{векторов касательного \hbox{базиса}}
(\en{the~second partial derivatives of}\ru{вторые частные производные}~$\locationvector$)
${\locationvector_{\differentialindex{i}\hspace{.2ex}\differentialindex{\hspace{-0.1ex}j}} \hspace{-0.2ex} \equiv \partial_i \partial_j \locationvector \hspace{-0.1ex} = \partial_i \hspace{.12ex} \locationvector_\differentialindex{\hspace{-0.1ex}j}}$,
%
\item
\en{the}\ru{символы} \hbox{Christoffel}\ru{’я}\en{ symbols}
\en{of metric connection}\ru{метрической связности}
${\Gamma_{\hspace{-0.25ex}i\hspace{-0.1ex}j}^{\hspace{.25ex}k} \hspace{-0.1ex} \equiv \locationvector_{\differentialindex{i}\hspace{.2ex} \differentialindex{\hspace{-0.1ex}j}} \hspace{-0.2ex} \dotp \locationvector^k
%%\hspace{-0.32ex} = \Gamma_{\hspace{-0.25ex}i\hspace{-0.1ex}j\mathdotbelow{n}} \hspace{.25ex} \textsl{g}^{\hspace{.25ex}nk}\hspace{-0.25ex}
}$
\en{and}\ru{и}~${\Gamma_{\hspace{-0.25ex}i\hspace{-0.1ex}j\mathdotbelow{k}} \hspace{-0.16ex} \equiv \locationvector_{\differentialindex{i}\hspace{.2ex}\differentialindex{\hspace{-0.1ex}j}} \hspace{-0.2ex} \dotp \locationvector_\differentialindex{k}
...
индексам
(а~не~только по~второму и~третьему).
И~тогда
равен нулю~${\hspace{-0.2ex} \zerotetravalent}$
следующий тензор четвёртой сложности\:---
\href{https://en.wikipedia.org/wiki/Riemann_curvature_tensor}{%
\emph{\ru{тензор кривизны }Riemann\ru{’а}\en{ curvature tensor}}
(\en{or}\ru{или}~\emph{\ru{тензор }Riemann\ru{’а}\hbox{--}Christoffel\ru{’я}\en{ tensor}})%
}
...
\en{The~six independent components}\ru{Шесть независимых компонент}
${\mathfrak{R}_{\hspace{.1ex}1212}}$,
${\mathfrak{R}_{\hspace{.1ex}1213}}$,
${\mathfrak{R}_{\hspace{.1ex}1223}}$,
${\mathfrak{R}_{\hspace{.1ex}1313}}$,
${\mathfrak{R}_{\hspace{.1ex}1323}}$,
${\mathfrak{R}_{\hspace{.1ex}2323}}$.

...

\en{The symmetric}\ru{Симметричный}
\en{bivalent}\ru{бивалентный}
\href{https://en.wikipedia.org/wiki/Ricci_curvature}{\emph{\ru{тензор кривизны }Ricci\en{ curvature tensor}}}
...
\vspace{-0.2em} \noindent
(\en{coefficient}\ru{коэффициент}~$\onefourth$
\en{is used here for convenience}\ru{используется тут для удобства})
\en{with components}\ru{с~компонентами}

\vspace{.1em}\begin{equation*}
\begin{array}{ccc}
\mathscr{R}^{\hspace{.1ex}1\hspace{-0.1ex}1} \hspace{-0.3ex} =
\scalebox{.8}{$ \displaystyle \frac{\raisemath{-0.2em}{1}}{\raisemath{.15em}{\smash{\textsl{g}}}} $} \hspace{.4ex} \mathfrak{R}_{\hspace{.1ex}2323}
\hspace{.2ex} ,
&
&
\\[.6em]
...
\scalebox{.8}{$ \displaystyle \frac{\raisemath{-0.2em}{1}}{\raisemath{.15em}{\smash{\textsl{g}}}} $} \hspace{.4ex} \mathfrak{R}_{\hspace{.1ex}1323}
\hspace{.2ex} ,
&
\mathscr{R}^{\hspace{.1ex}22} \hspace{-0.3ex} =
\scalebox{.8}{$ \displaystyle \frac{\raisemath{-0.2em}{1}}{\raisemath{.15em}{\smash{\textsl{g}}}} $} \hspace{.4ex} \mathfrak{R}_{\hspace{.1ex}1313}
\hspace{.2ex} ,
&
\\[.6em]
%
\mathscr{R}^{\hspace{.1ex}31} \hspace{-0.3ex} =
\scalebox{.8}{$ \displaystyle \frac{\raisemath{-0.2em}{1}}{\raisemath{.15em}{\smash{\textsl{g}}}} $} \hspace{.4ex} \mathfrak{R}_{\hspace{.1ex}1223}
\hspace{.2ex} ,
&
\mathscr{R}^{\hspace{.1ex}32} \hspace{-0.3ex} =
\scalebox{.8}{$ \displaystyle \frac{\raisemath{-0.2em}{1}}{\raisemath{.15em}{\smash{\textsl{g}}}} $} \hspace{.4ex} \mathfrak{R}_{\hspace{.1ex}1213}
\hspace{.2ex} ,
&
\mathscr{R}^{\hspace{.1ex}33} \hspace{-0.3ex} =
\scalebox{.8}{$ \displaystyle \frac{\raisemath{-0.2em}{1}}{\raisemath{.15em}{\smash{\textsl{g}}}} $} \hspace{.4ex} \mathfrak{R}_{\hspace{.1ex}1212}
\hspace{.2ex} .
\end{array}
\end{equation*}

\en{The equality}\ru{Равенство}
\en{of the}\ru{тензора} Ricci\en{ tensor}
\en{to zero}\ru{нулю}
${\hspace{.1ex}\pmb{\scalebox{1.2}[1]{$\mathscr{R}$}} \hspace{-0.16ex} = \hspace{-0.2ex} \zerobivalent}$
(\en{in components}\ru{в~компонентах}
\en{these are six equations}\ru{это шесть уравнений}
${\hspace{.1ex}\mathscr{R}^{\hspace{.1ex}i\hspace{-0.1ex}j} \hspace{-0.3ex} = \mathscr{R}^{\hspace{.1ex}j\hspace{-0.06ex}i} \hspace{-0.3ex} = 0}$)
\en{is}\ru{есть}
\en{the~}\textcolor{magenta}{\en{necessary}\ru{необходимое}}
\en{condition}\ru{условие}
\en{of~integrability}\ru{интегрируемости}
(\inquotes{compatibility}\ru{--- \inquotesx{совместимости}[,] \inquotes{совместности}})
\en{for}\ru{для}
\en{determining}\ru{определения}
\en{the location}\ru{вектора положения}~(\inquotes{\en{radius}\ru{радиуса}})\en{ vector}~%
${\locationvector(q^{\hspace{.1ex}k})}$
\en{by the~known}\ru{по~известному}
\en{field}\ru{полю}~%

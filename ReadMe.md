...
Слово «континуумов» в названии говорит, что тело (среда) моделируется здесь не как дискретная коллекция частиц, но как непрерывное поле векторов положения, непрерывная материя. Это даёт большое удобство, потому что аппарат calculus’а (исчисления) бесконечно малых может быть использован для таких моделей.

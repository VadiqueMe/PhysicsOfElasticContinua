...
\en{The~parity of~permutations tensor}\ru{Тензор чётности перестановок}
\en{is}\ru{это}
...
\en{the~parity of~permutations symbol}\ru{символу чётности перестановок}
...
\en{With}\ru{С}~\textcolor{magenta}{\en{the Levi\hbox{-}Civita tensor}\ru{тензором Л\'{е}ви\hbox{-\!}Чив\'{и}ты}}~$\permutationsparitytensor$
\en{it is possible}\ru{возможно}
\en{to take the~fresh look}\ru{по\hbox{-}новому взглянуть}
\en{at the~cross product}\ru{на~векторное произведение}\::
...
\en{With }\ru{С~}\en{the}\ru{тензором} \textcolor{magenta}{Levi\hbox{-}Civita\ru{\hspace{-0.1ex}’ы}}\en{ tensor}
...
\en{The contraction of}\ru{Свёртка}~\eqref{doubleveblen}
...
\en{of~these formulas}\ru{из~этих формул}
\en{gives}\ru{даёт}
\en{the~following}\ru{следующее}
\en{representation}\ru{представление}
\en{of~double}\ru{двойного}
\hbox{\hspace{-0.2ex}\inquotes{${\hspace{-0.25ex}\times\hspace{-0.1ex}}$}\hspace{-0.2ex}-\en{product}\ru{произведения}}
...
\en{for any two vectors}\ru{для~любых двух векторов}~$\bm{a}$
\en{and}\ru{и}~$\bm{b}$

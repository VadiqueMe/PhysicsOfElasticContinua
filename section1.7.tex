...
\nopagebreak\vspace{-0.1em}\begin{equation*}
\begin{array}{c}
\bm{A} = - \, \permutationsparitytensor \dotp \bm{a} = - \hspace{.1ex} \permutationsparity_{i\hspace{-0.1ex}j\hspace{-0.1ex}k} \hspace{.1ex} \bm{e}_i \bm{e}_j a_k ,
\\[.3em]
A_{i\hspace{-0.1ex}j} = - \hspace{.1ex} \permutationsparity_{i\hspace{-0.1ex}j\hspace{-0.1ex}k} \hspace{.1ex} a_k \hspace{.1em} = \hspace{-0.1em}
...
\en{The easy to remember}\ru{Легко запоминающийся}
\inquotes{\en{pseudovector invariant}\ru{псевдовекторный инвариант}}
${\!\bm{A}_{\!\bm{\times}}}$
\en{comes from the original tensor}\ru{происходит из оригинального тензора}~${\hspace{-0.2ex}\bm{A}}$
...
\tikzmark{beginTwoPermutationsParities} \permutationsparity_{ni\hspace{-0.1ex}j} \permutationsparity_{nkp} \tikzmark{endTwoPermutationsParities}
...
\end{equation*}
%
\AddUnderBrace[line width=.75pt][0,-0.25ex]{beginTwoPermutationsParity}
{${ \scriptstyle \permutationsparity_{i\hspace{-0.1ex}jn} \bm{e}_n $}
\AddUnderBrace[line width=.75pt][.25ex,-0.25ex]{endTwoPermutationsParity}
{${ \scriptstyle
   \hspace{3.2em}
...
\vspace{-0.6em}
\en{You can introduce}\ru{Ты можешь ввести}

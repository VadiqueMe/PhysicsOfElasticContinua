...
\en{give}\ru{дают} ${(-1)^2 = 1}$,
\en{mutually compensating each other}\ru{взаимно компенсируя друг друга}.
...
\en{then}\ru{тогда}
\en{the~basis triple}\ru{базисная тройка}~${\bm{e}_i}$
\en{is oriented negatively}\ru{ориентирована отрицательно}, \en{or}\ru{или} \inquotesx{\en{mirrored}\ru{зеркально}}[.]

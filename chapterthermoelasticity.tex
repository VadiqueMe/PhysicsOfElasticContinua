...
\en{It is widely known}\ru{Широк\'{о} известно}, \en{however}\ru{однако}, \en{that a~change in~temperature causes deformation}\ru{что изменение температуры вызывает деформацию}.
...
\en{For}\ru{Для} \en{any}\ru{любого} \en{finite}\ru{кон\'{е}чного} \en{volume}\ru{объёма} \en{of~material continuum}\ru{материального контину\kern-0.11exума}

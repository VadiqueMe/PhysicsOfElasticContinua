...
\displaystyle\Biggl( \integral\displaylimits_{\mathcal{V}} \hspace{-0.5ex} \rho \hspace{.15ex} s \hspace{.25ex} d\mathcal{V} \hspace{-0.2ex} \Biggr)^{\hspace{-0.5ex}\timederivativedot} \hspace{-0.1ex}
\geq \hspace{.1ex}

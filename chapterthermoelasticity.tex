...
\footnote{\en{Analogue}\ru{Аналог} \en{of the~principle of virtual work}\ru{принципа виртуальной работы} \en{will be presented}\ru{будет представлен} \en{below}\ru{ниже} \en{in}\ru{в}~\pararef{para:variationalformulations.thermoelasticity}.}\hbox{\hspace{-0.5ex}.}
...
\vspace{-0.1em}
\en{Internal energy}\ru{Внутренняя энергия}~$E$ \en{is}\ru{есть} \en{the~sum}\ru{сумма} \en{of the~}\en{kinetic}\ru{кинетической} \en{and}\ru{и}~\en{potential}\ru{потенциальной} \en{energies}\ru{энергий} \en{of~particles}\ru{частиц}.
\en{For}\ru{Для} \en{any}\ru{любого} \en{finite}\ru{кон\'{е}чного} \en{volume}\ru{объёма} \en{of a~material continuum}\ru{материального контину\kern-0.11exума}
...
\smalldisplaystyleonehalf \hspace{.2ex} \mathdotabove{\currentlocationvector} \dotp \mathdotabove{\currentlocationvector} \hspace{.1ex}
+ e
\Bigr) d\mathcal{V} .
\end{equation}
...
\en{But how}\ru{Но как} \en{to~adapt}\ru{адаптировать} \en{this}\ru{это} \en{for}\ru{для} \en{a~continuum}\ru{контину\kern-0.11exума} \en{with an~inhomogeneous}\ru{с~неоднородным} \en{temperature field}\ru{полем температуры}?
...
\en{The~most appropriate}\ru{Наиболее подходящим} \en{expression}\ru{выражением} \en{of the~second law of~thermodynamics}\ru{второго закона термодинамики} \en{for material continuum}\ru{для материального контину\kern-0.11exума} \en{seems to be}\ru{видится} \ru{неравенство }\en{the~}Clausius\ru{’а}\hbox{--}Duhem\ru{’а}\en{ inequality}

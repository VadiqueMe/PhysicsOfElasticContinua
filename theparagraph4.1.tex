...
\en{of the equations}\ru{уравнений}
...
\begin{itemize}
\item \en{the balance of forces}\ru{баланс сил},
\item \en{the stress--strain relations}\ru{отношения напряжение--деформация},
\item ${\bm{u} \mapsto \infinitesimaldeformation}$.
%\en{the infinitesimal}\ru{бесконечномалые} \en{linear strain}\ru{линейные деформации}
%\en{from the displacements}\ru{от перемещений}.
\end{itemize}
...
$\bm{v}$
\en{is the vector}\ru{это вектор}
\en{of the volume loads}\ru{объёмных нагрузок},
$\infinitesimaldeformation$
\ru{это}\en{is}
\en{the tensor}\ru{тензор}
 \en{of the infinitesimal linear deformation}\ru{бесконечномалой линейной деформации},
${
   \potential(
...
$\ru{это}\en{is}
\en{the elastic potential energy}\ru{упругая потенциальная энергия}
...
\item
   ${
      \scalebox{.95}{$ \raisemath{.15em}{
         \scalebox{.92}{$ \partial^2 \hspace{.1ex} \potential $}
      }
      / %it is division
      \hspace{-0.1ex}

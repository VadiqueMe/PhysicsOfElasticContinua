...
\en{This theory}\ru{Эта теория} \en{describes}\ru{описывает} \en{the two vector fields}\ru{два векторных поля}:
...
\foreignlanguage{russian}{в ваку\kern-0.11exуме нет $\chargedensity$ \en{and}\ru{и}~$\currentdensity$}
...
\vspace{-0.15em}\noindent
\en{A~more popular}\ru{Более популярный} \en{option}\ru{вариант}\ru{\:---}\en{ is} \en{even more tight}\ru{ещё более жёсткое} \en{condition}\ru{условие}

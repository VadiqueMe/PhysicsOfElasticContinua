...
%
\en{The magnetic field}\ru{Магнитное поле}
\en{is changing}\ru{изменяется}
\en{because of body’s deformation}\ru{из\hbox{-}за деформации т\'{е}ла}.
%
\en{If}\ru{Если}
...
\en{then}\ru{тогда}
\ru{возникает }\en{a~problem}\ru{проблема}
\en{of elasticity}\ru{упругости}
\en{along with magnetism}\ru{вместе с~магнетизмом}\en{ emerges}.

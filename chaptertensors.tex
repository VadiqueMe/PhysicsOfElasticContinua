...
\ru{\lettrine[lines=2, findent=2pt, nindent=0pt]{У}{поминание} тензоров может отпугнуть читателя, обычно избегающего ненужных сложностей. Не бойся: тензоры вводятся лишь из\hbox{-}за своего чудесного свойства инвариантности\:--- независимости от систем координат. Предлагаю начать знакомство с~тензорами через воспоминания о~векторах.}
...
\en{\vspace{-0.1em} Matrix of cosines is orthogonal, meaning that it inverses on~transposing:}
...
B\hspace{.16ex}'_{\hspace{-0.32ex}i\hspace{-0.1ex}j} \hspace{-0.16ex} = \cosinematrix{i'\hspace{-0.1ex}m} \hspace{.1ex} \cosinematrix{j'\hspace{-0.1ex}n} \hspace{.16ex} B_{mn} \hspace{0.1ex},
\end{equation}
...
\en{I\kern-0.12ext’s easy to show}\ru{Легко показать,} \en{that}\ru{что} \en{components}\ru{компоненты} \en{of~the~result}\ru{результата}~$\bm{c}$ \en{satisfy}\ru{удовлетворяют} \en{the~orthogonal transformation}\ru{ортогональному преобразованию} \en{like}\ru{вида}~\eqref{orthotransform:2}.
...
\en{The~third operation}\ru{Третье действие} \en{is called}\ru{называется} \en{contraction}\ru{свёрткой~(contraction)}.
...
\en{Roughly speaking}\ru{Грубо говоря}, \en{contracting a~tensor}\ru{свёртывание тензора} \en{is}\ru{есть} \en{components summing}\ru{суммирование компонент} \en{over}\ru{по} \en{some}\ru{какой\hbox{-}либо} \en{pair of~indices}\ru{паре индексов}.
\en{As a~result,}\ru{В~результате} \en{tensor’s complexity}\ru{сложность тензора} \en{decreases by two}\ru{уменьшается на~два}.

\en{For trivalent tensor}\ru{Для трёхвалентного тензора}~${\hspace{-0.1ex} ^3\hspace{-0.33ex}\bm{D}}$\en{,} \ru{возможны }\en{three variants}\ru{три варианта} \en{of~contraction}\ru{свёртки}\en{ are possible}, \en{giving vectors}\ru{дающие векторы}~${\bm{a}}$, ${\bm{b}}$ \en{and}\ru{и}~${\bm{c}}$

\nopagebreak\vspace{-0.25em}\begin{equation}\label{action:3}
...
\vspace{-0.25em}\noindent \en{With a~rotation of~basis}\ru{С~поворотом базиса}
...
\vspace{-0.16em} \en{The~trace}\ru{След} \en{of~the~unit tensor}\ru{единичного тензора} (\inquotes{\en{contraction of~the~Kronecker delta}\ru{свёртка дельты Kronecker’а}}) \en{is}\ru{есть} \en{the~dimension of~space}\ru{размерность пространства}

\nopagebreak\vspace{-0.2em}\begin{equation*}
\operatorname{tr} \bm{E} = \hspace{-0.1ex} \bm{E}\tracedot = \delta_{kk} \hspace{-0.2ex} = \hspace{.1ex} \delta_{11} \hspace{-0.2ex} + \delta_{22} \hspace{-0.2ex} + \delta_{33} \hspace{-0.1ex} = \hspace{.1ex} 3
\hspace{.1ex} .
\end{equation*}
...
& \!\Leftrightarrow\!\! &
A_{i\hspace{-0.1ex}j\hspace{-0.1ex}k} = D_{j\hspace{-0.07ex}ik} \hspace{.1ex},
\\
{^3\hspace{-0.15em}\bm{B}} = {^3\hspace{-0.16em}\bm{D}}_{1 \scalebox{0.6}[0.8]{$\rightleftarrows$} 3}
& \!\Leftrightarrow\!\! & B_{i\hspace{-0.1ex}j\hspace{-0.1ex}k} = D_{kj\hspace{-0.07ex}i} \hspace{.1ex},
\\
...
B_{i\hspace{-0.1ex}j} \hspace{-0.1ex} = A_{j\hspace{-0.07ex}i}}$.
...
${\bm{A} \dotdotp \hspace{-0.1ex} \bm{B} = A_{\hspace{.1ex}i\hspace{-0.1ex}j} B_{\hspace{-0.1ex}j\hspace{-0.07ex}i}}$,
...
\\[.2em]
%
\bm{A} \dotdotp \bm{B} = \bm{A}^{\hspace{-0.16ex}\T} \hspace{-0.2ex} \dotdotp \bm{B}^{\T} \hspace{-0.2ex} = A_{\hspace{.1ex}i\hspace{-0.1ex}j} B_{\hspace{-0.1ex}j\hspace{-0.07ex}i}
\hspace{.12ex} ,
\;\;
...
\en{However}\ru{Однако}, \en{a~}cross product\ru{~(векторное произведение)}\en{ is}\ru{\:---} \en{not quite a~vector}\ru{не~вполн\'{е} вектор}, \en{since}\ru{поскольку} \en{it isn’t completely invariant}\ru{оно не~полностью инвариантно}.
...
Сначала введём символ перестановки (permutation symbol) \hbox{O.\hspace{.1ex}Veblen’а}~${e_{i\hspace{-0.1ex}j\hspace{-0.1ex}k}}$:
...
остальные нули.
Символ~${e_{i\hspace{-0.1ex}j\hspace{-0.1ex}k}}$~(${\pm 1}$ или~$0$) меняет знак при~перестановке любых двух индексов, не~меняется при двойной~(\inquotes{круговой}) перестановке индексов и~обращается в~нуль при~совпадении какой\hbox{-}либо пары.

Через символ Веблена определитель~(детерминант) матрицы~${A_{i\hspace{-0.1ex}j}}$ выражается так:

\nopagebreak\vspace{-0.25em}\begin{equation*}
\operatorname{det} A_{i\hspace{-0.1ex}j} \hspace{-0.2ex} = e_{i\hspace{-0.1ex}j\hspace{-0.1ex}k} A_{1i} A_{2j} A_{3k} \hspace{-0.2ex} = e_{i\hspace{-0.1ex}j\hspace{-0.1ex}k} A_{i1} A_{j2} A_{k3} \hspace{.1ex} .
\end{equation*}
...
\pm \operatorname{det}\hspace{-0.25ex} \scalebox{0.96}[0.96]{$\left[\begin{array}{ccc}
...
\bm{C}^{\hspace{.1ex}\T} \hspace{-0.32ex} = \bm{C}^{\mathsf{\hspace{.1ex}S}} \hspace{-0.1ex}-\hspace{.1ex} \bm{C}^{\mathsf{\hspace{.1ex}A}}
\hspace{.2ex} ;
\\[0.2em]
\bm{C}^{\mathsf{\hspace{.1ex}S}} \equiv \displaystyle \onehalf \left( {\bm{C} + \bm{C}^{\hspace{.1ex}\T}}\hspace{.1ex} \right)\!, \;
\bm{C}^{\mathsf{\hspace{.1ex}A}} \equiv \displaystyle \onehalf \left( {\bm{C} - \bm{C}^{\hspace{.1ex}\T}}\hspace{.1ex} \right)\!.
\end{array}\end{equation}
...
\smalldisplaystyleonehalf \hspace{.25ex} A_{j\hspace{-0.1ex}k} \levicivita_{kj\hspace{-0.07ex}i} \hspace{.2ex} \bm{e}_i , \\[0.64em]
...
\mathrm{III} & = & \operatorname{det} \hspace{.1ex} {^2\!\bm{B}} = \operatorname{det} B_{i\hspace{-0.1ex}j} = e_{i\hspace{-0.1ex}j\hspace{-0.1ex}k} \hspace{.1ex} B_{1i} B_{2j} B_{3k} = e_{i\hspace{-0.1ex}j\hspace{-0.1ex}k} \hspace{.1ex} B_{i1} B_{\hspace{-0.1ex}j2} B_{k3} \hspace{.1ex} .
\end{array}\end{equation}
...
- \hspace{-0.2ex} B_{i\hspace{-0.1ex}j} B_{\hspace{-0.1ex}j\hspace{-0.07ex}i} \hspace{.12ex}
\right]$}
\hspace{-0.25ex} .
\end{equation*}
...
\vspace{-1.4em} При~различных собственных числах собственные векторы единичной длины~${\mathboldae_i}$ образуют ортонормальный базис. Каков\'
...
{beginEqualsKroneckerDelta}{endEqualsKroneckerDelta}{${\scriptstyle \delta_{j\hspace{-0.07ex}i}}$}
...
\smalldisplaystyleonehalf \hspace{.2ex} \levicivita_{j\hspace{-0.07ex}ik} \hspace{.32ex} \cosinematrix{\hspace{-0.4ex}n\mathcircabove{j}} \hspace{.4ex} \cosinematrixdotted{\hspace{-0.4ex}n\mathcircabove{i}} \hspace{.4ex} \mathcircabove{\bm{e}}_k
\hspace{.2ex} .
\end{equation}
...
${ \tikz[baseline=-1ex] \draw [line width=.5pt, color=black, fill=white] (0, 0) circle (.8ex);
\hspace{.6em} }$
Доказательство напоминает вывод~\eqref{doubleveblen}. \inquotes{Тройное} произведение ${\bm{a}_i \hspace{-0.25ex} \times \hspace{-0.25ex} \bm{a}_j \dotp \hspace{0.1ex} \bm{a}_k}$ в~каком\hbox{-}нибудь \inquotes{правом} орто\-нормаль\-ном базисе~${\bm{e}_i}$ вычисл\'{и}мо как~детерминант по~строкам
...
\hspace{.1ex} \operatorname{det}\hspace{-0.1ex}
...
\vspace{-0.1em} \noindent
${i \narroweq p \narroweq 1}$, ${j \narroweq q \narroweq 2}$, ${k \narroweq r \narroweq 3}$ ${\,\Rightarrow}$ ${\levicivita_{123} \hspace{.2ex} \levicivita_{123} \hspace{-0.12ex}= \underset{i,\hspace{.1ex}j}{\operatorname{det}} \left( \bm{a}_i \dotp \bm{a}_j \right) \hspace{-0.1ex}= \underset{i,\hspace{.1ex}j}{\operatorname{det}} \, \textsl{g}_{i\hspace{-0.1ex}j}}$.
${ \hspace{.6em}
\tikz[baseline=-0.6ex] \draw [color=black, fill=black] (0, 0) circle (.8ex); }$
...
= \textsl{g}^{\hspace{.2ex}j\hspace{-0.07ex}i} \bm{a}_j \hspace{.1ex} ,
\\[.25em]
%
\bm{a}_i
...
= \textsl{g}_{j\hspace{-0.07ex}i} \hspace{.16ex} \bm{a}^{\hspace{.1ex}j} \hspace{-0.2ex} .
\end{array}\end{equation}
...
\noindent \en{In~the~popular conception of~function}\ru{В~популярном представлении о~функции}~${y \narroweq \hspace{-0.15ex} f(x)}$
...
= \hspace{-0.1ex} B_{i\hspace{-0.1ex}j} \hspace{-0.15ex} \scalebox{1.2}[1]{$\mathit{\Phi}$}^{\hspace{.1ex}j\hspace{-0.07ex}i} \hspace{-0.25ex}
...
\vspace{.2em} \noindent \textcolor{cyan}{добавить:} симметрия ${ \Gamma_{\hspace{-0.25ex}i\hspace{-0.1ex}j\mathdotbelow{k}} = \Gamma_{\hspace{-0.33ex}j\hspace{-0.07ex}i\mathdotbelow{k}} }$, поэтому ${3^3 \hspace{-0.2ex} - 3 \hspace{-0.2ex}\cdot\hspace{-0.2ex} 3 = 18}$ разных~(независимых) ${\Gamma_{\hspace{-0.25ex}i\hspace{-0.1ex}j\mathdotbelow{k}}}$
...
%
= \smalldisplaystyleonehalf \hspace{-0.2ex} \left( \bm{r}_{i\hspace{-0.1ex}j} \hspace{-0.16ex} + \bm{r}_{\hspace{-0.2ex}j\hspace{-0.07ex}i} \right) \hspace{-0.1ex} \dotp \bm{r}_k \hspace{-0.1ex}
...
+ \smalldisplaystyleonehalf \hspace{-0.2ex} \left( \scalebox{0.96}[1]{$\bm{r}_{\hspace{-0.2ex}j\hspace{-0.07ex}i} \hspace{-0.2ex} \dotp \bm{r}_k \hspace{-0.16ex} + \bm{r}_{\hspace{-0.2ex}j\hspace{-0.1ex}k} \hspace{-0.2ex} \dotp \bm{r}_i$} \right) \hspace{-0.16ex}
...
\bm{r}_h \hspace{-0.15ex} \dotp \left( \hspace{.12ex} \bm{r}_{\hspace{-0.2ex}j\hspace{-0.07ex}ik} \hspace{-0.2ex} - \bm{r}_{i\hspace{-0.1ex}j\hspace{-0.1ex}k} \hspace{.12ex} \right)
\hspace{-0.3ex} .
\end{equation}
...
${\hspace{.1ex}\pmb{\scalebox{1.2}[1]{$\mathscr{R}$}} \hspace{-0.16ex} = \hspace{-0.2ex} {^2\bm{0}}}$ (в~компонентах это шесть уравнений ${\hspace{.1ex}\mathscr{R}^{\hspace{.1ex}i\hspace{-0.1ex}j} \hspace{-0.3ex} = \mathscr{R}^{\hspace{.1ex}j\hspace{-0.07ex}i} \hspace{-0.3ex} = 0}$) \en{is}\ru{есть} \en{necessary condition}\ru{необходимое условие} \en{of~integrability}\ru{интегрируемости}~(\ru{\inquotes{совместности}, }\inquotes{compatibility}) при определении вектора-радиуса~${\bm{r}(q^{\hspace{.1ex}k})}$ по~полю~${\textsl{g}_{i\hspace{-0.1ex}j}(q^{\hspace{.1ex}k})}$.

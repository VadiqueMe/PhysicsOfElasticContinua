...
\en{and}\ru{и} \en{with a~transition}\ru{с~переходом} \en{to a~new orthonormal basis}\ru{к~новому ортонормированному базису} \en{it is transformed}\ru{она преобразуется} \en{according to}\ru{согласно}~\eqref{orthotransform:1};

...
B'_{i\hspace{-0.1ex}j} \hspace{-0.16ex} = \cosinematrix{i'm} \hspace{.1ex} \cosinematrix{j'n} \hspace{.16ex} B_{mn} \hspace{0.1ex},
\end{equation}
...
\nopagebreak\vspace{-0.2em}\begin{equation*}
\left( B_{i\hspace{-0.1ex}j} \bm{e}_i \bm{e}_j \right)_{pq} \hspace{-0.2ex} = B_{i\hspace{-0.1ex}j} \hspace{.1ex} \delta_{ip} \delta_{jq} \hspace{-0.1ex} = B_{pq}
\end{equation*}
...
\nopagebreak\vspace{-0.2em}\begin{equation*}
B'_{i\hspace{-0.1ex}j} \bm{e}'_{i} \bm{e}'_{j} \hspace{-0.1ex} = \cosinematrix{i'p} \cosinematrix{j'q} B_{pq} \cosinematrix{i'n} \bm{e}_n \cosinematrix{j'm} \bm{e}_m \hspace{-0.2ex} = \delta_{pn} \delta_{qm} B_{pq} \bm{e}_n \bm{e}_m \hspace{-0.2ex} = B_{pq} \bm{e}_p \bm{e}_q \hspace{.1ex} .
\end{equation*}

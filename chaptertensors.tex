...
p_j \hspace{-0.16ex} = n_i \tau_{i\hspace{-0.1ex}j} \hspace{0.1ex}, \;\;
m_i \hspace{-0.16ex} = e_{i\hspace{-0.1ex}jk} \hspace{.16ex} x_j f_k \hspace{0.1ex}, \;\;
...
a_{i\hspace{-0.1ex}j} \hspace{-0.25ex} = k_i \gamma_{i\hspace{-0.1ex}j} \hspace{0.1ex}.
\]
\par}
\vspace{.1em}

\en{Vector~${\bm{v}}$ is invariant, it doesn’t depend on any coordinate system. I\kern-0.12exts decomposition in two cartesian systems with basis unit vectors ${\bm{e}_{i}}$ and~${\bm{e}'_{i}}$ gives}
...
\en{Orthonormal basis vectors of an~\inquotes{old} and~a~\inquotesx{new}[---] rotated\:--- cartesian coordiantes are connected via rotation matrix (matrix of~\inquotes{direction} cosines) ${\cosinematrix{i'\hspace{-0.1ex}k}\hspace{.1ex}}$:}

\ru{Ортонормальные базисные векторы \inquotes{старых} и~\inquotesx{новых}[---] повёрнутых\:--- декартовых координат связываются через матрицу поворота (матрицу \inquotes{направляющих} косинусов) ${\cosinematrix{i'\hspace{-0.1ex}k}\hspace{.1ex}}$:}

\nopagebreak\vspace{-0.25em}\begin{equation}
\bm{e}'_{i} \hspace{-0.16ex} = \cosinematrix{i'\hspace{-0.1ex}k} \hspace{.1ex} \bm{e}_k \hspace{0.1ex}, \;\:
(\hspace{0.32ex} \dotp \hspace{.25ex} \bm{e}_k \hspace{0.25ex}) \,\Rightarrow\: \cosinematrix{i'\hspace{-0.1ex}k} \hspace{-0.16ex} = \bm{e}'_{i} \dotp \bm{e}_k \hspace{-0.16ex} = \operatorname{cos} \measuredangle (\bm{e}'_{i} \hspace{.1ex}, \bm{e}_k).
\end{equation}
...
\vspace{-0.2em} \noindent (\en{proof}\ru{доказательство}: $\delta_{i\hspace{-0.1ex}j} \hspace{-0.15ex} = \bm{e}'_i \hspace{-0.12ex} \dotp \bm{e}'_j \hspace{-0.16ex} = \cosinematrix{i'\hspace{-0.1ex}k} \hspace{.1ex} \bm{e}_k \hspace{-0.12ex} \dotp \cosinematrix{j'\hspace{-0.1ex}n} \hspace{.1ex} \bm{e}_n \hspace{-0.16ex} = \cosinematrix{i'\hspace{-0.1ex}k} \hspace{.1ex} \cosinematrix{j'\hspace{-0.1ex}n} \delta_{kn} \hspace{-0.16ex} = \cosinematrix{i'\hspace{-0.1ex}k} \hspace{.1ex} \cosinematrix{j'\hspace{-0.1ex}k} \hspace{0.1ex}$).
...
v'_i = v_k \hspace{.2ex} \bm{e}_k \hspace{-0.12ex}\dotp \bm{e}'_i \hspace{-0.12ex} = \cosinematrix{i'\hspace{-0.1ex}k} \hspace{.2ex} v_k
\end{equation}
...
\nopagebreak \vspace{-0.2em} ${|\bm{v}|^2 \hspace{-0.1ex} = \bm{v} \dotp \bm{v} = v'_i \hspace{.2ex} v'_i \hspace{-0.16ex} = \cosinematrix{i'\hspace{-0.1ex}k} \hspace{.1ex} v_k \hspace{.2ex} \cosinematrix{i'\hspace{-0.1ex}n} \hspace{.1ex} v_n \hspace{-0.16ex} = v_n v_n \hspace{-0.2ex}}$~\en{--- this conclusion leans on}\ru{--- этот вывод опирается на}~\eqref{orthogonalityofcosinematricies}.
...
B'_{i\hspace{-0.1ex}j} \hspace{-0.16ex} = \cosinematrix{i'\hspace{-0.1ex}m} \hspace{.1ex} \cosinematrix{j'\hspace{-0.1ex}n} \hspace{.16ex} B_{mn} \hspace{0.1ex},
\end{equation}
...
\en{In other words}\ru{Иными словами}, \en{tensor}\ru{тензор}~${^2\!\bm{B}}$ \en{reveals in every basis as a~collection (matrix) of its components}\ru{проявляется в~каждом базисе совокупностью (матрицей) своих компонент}~${B_{i\hspace{-0.1ex}j}}$, \en{changing along with a~basis according to}\ru{меняющейся вместе с~базисом согласно}~\eqref{orthotransform:2}.
...
\nopagebreak\en{The first}\ru{Первое}\:--- \en{linear combination}\ru{линейная комбинация}\:--- \en{aggregates}\ru{объединяет} \en{addition}\ru{сложение} \en{and}\ru{и}~\en{multiplication by~number}\ru{умножение на~число}. \en{Arguments of this operation and its result}\ru{Аргументы этого действия и~его результат}\en{ are}\ru{\:---} \en{of the~same complexity}\ru{одинаковой сложности}. \en{Combining two tensors looks like this}\ru{Комбинирование двух тензоров выглядит так}:

\nopagebreak\vspace{-0.2em}\begin{equation}\label{action:1}
\lambda a_{i\hspace{-0.1ex}j\ldots} \hspace{-0.2ex} + \hspace{0.2ex} \mu b_{i\hspace{-0.1ex}j\ldots} \hspace{-0.2ex} = \hspace{0.2ex} c_{i\hspace{-0.1ex}j\ldots} \hspace{-0.2ex} \;\Leftrightarrow\; \lambda \bm{a} + \mu \bm{b} = \bm{c}.
\end{equation}
...
\en{I\kern-0.12ext’s easy to show}\ru{Легко показать,} \en{that}\ru{что} \en{components}\ru{компоненты} \en{of~the~result}\ru{результата}~$\bm{c}$ \en{satisfy}\ru{удовлетворяют} \en{an~orthogonal transformation}\ru{ортогональному преобразованию} \en{like}\ru{вида}~\eqref{orthotransform:2}.
...
\en{The second operation is multiplication~(tensor product, direct product). I\kern-0.12ext~takes arguments of~any complexities, returning result of cumulative complexity. Examples:}
...
\begin{array}{rcl}
v_i a_{jk} \hspace{-0.16ex} = C_{i\hspace{-0.1ex}jk} & \Leftrightarrow & \bm{v} \, {^2\hspace{-0.2ex}\bm{a}} = {^3\hspace{-0.15ex}\bm{C}},
\\[.1em]
...
\[
a'_{i} = D'_{kki} = \tikzmark{BeginDeltaPQBrace} {\cosinematrix{k'\hspace{-0.1ex}p} \hspace{.1ex} \cosinematrix{k'\hspace{-0.1ex}q}} \tikzmark{EndDeltaPQBrace} \hspace{.1ex} \cosinematrix{i'\hspace{-0.1ex}r} \hspace{0.16ex} D_{pqr} = \cosinematrix{i'\hspace{-0.1ex}r} \hspace{.16ex} D_{ppr} = \cosinematrix{i'\hspace{-0.1ex}r} \hspace{.16ex} a_{r},
\]
\AddUnderBrace[line width = .75pt][.123ex, -0.2ex]{BeginDeltaPQBrace}{EndDeltaPQBrace}%
...
\bm{B}\tracedot \hspace{.3ex} \equiv \hspace{.3ex}
\operatorname{tr} \bm{B} \hspace{.2ex} \equiv \hspace{.4ex}
...
\en{Components of constructed sum}\ru{Компоненты построенной суммы}

\nopagebreak\vspace{-0.2em}\begin{equation*}
\bigl( B_{i\hspace{-0.1ex}j} \hspace{.1ex} \bm{e}_i \bm{e}_{\hspace{-0.1ex}j} \bigr)_{\hspace{-0.2ex}p\hspace{.1ex}q} \hspace{-0.25ex} = \hspace{-0.1ex} B_{i\hspace{-0.1ex}j} \hspace{.1ex} \delta_{ip} \delta_{\hspace{-0.15ex}jq} \hspace{-0.1ex} = \hspace{-0.1ex} B_{pq}
\end{equation*}
...
\nopagebreak\vspace{-0.1em}\begin{equation*}
\bm{v} \dotp {^2\!\bm{B}} =
v_i\bm{e}_i \hspace{-0.1ex} \dotp B_{\hspace{-0.2ex}jk}\bm{e}_{\hspace{-0.1ex}j} \bm{e}_k \hspace{-0.1ex} =
v_i B_{\hspace{-0.2ex}jk} \delta_{i\hspace{-0.1ex}j} \hspace{.1ex} \bm{e}_k \hspace{-0.1ex} =
v_i B_{ik} \bm{e}_k
\hspace{.1ex} ,
...
\hspace{-0.1ex} B_{pq} \hspace{.1ex} \delta_{\hspace{-0.1ex}ip} \delta_{qj} \hspace{-0.15ex} =
...
\vspace{-0.5em} \en{Polyadic representation}\ru{Полиадное представление} \en{connects}\ru{соединяет} \en{direct and index notations}\ru{прямую и~индексную записи} \en{together}\ru{воедино}. \en{I\kern-0.12ext’s not worth}\ru{Не~ст\'{о}ит} \en{contraposing}\ru{пр\'{о}тиво\-постав\-л\'{я}ть} \en{one another}\ru{одно другому}. Прямая запись компактна, изящна, и~лишь она должна быть в~фундаментальных соотношениях. Но~и~индексная запись бывает удобна, например, при громоздких выкладках с~тензорами.
...
%
\AddUnderBrace[line width=.75pt][.2ex,-0.2ex]%
{BeginECrossE}{EndECrossE}{${\scriptstyle \;\;+\levicivita_{i\hspace{-0.1ex}jk} \bm{e}_i \bm{e}_k \bm{e}_j}$}
...
Когда базис~${\bm{e}_i}$ это \inquotes{правая} тройка взаимно ортогональных векторов единичной длины, тогда~${\sqrt{\hspace{-0.36ex}\mathstrut{\textsl{g}}} = \hspace{-0.1ex} 1}$, и~компоненты~$\levicivitatensor$ равны символу Веблена: ${\levicivita_{i\hspace{-0.1ex}jk} \hspace{-0.2ex} = e_{i\hspace{-0.1ex}jk}}$. Если~же тройка~${\bm{e}_i}$ \inquotesx{левая}[,] то~${\levicivita_{i\hspace{-0.1ex}jk} \hspace{-0.2ex} = \hspace{-0.1ex} - \hspace{.1ex} e_{i\hspace{-0.1ex}jk}}$.
...
%
%%A_{hj} & = & a_{i} \levicivita_{i\hspace{-0.1ex}jh} \\[0.1em]
...
%%B_{i\hspace{-0.1ex}j} a_j = \eigenvalue \delta_{i\hspace{-0.1ex}j} a_j \hspace{0.1ex},\;\;
\left(\hspace{0.1ex}
...
Или он~же
%%${ \operatorname{tr} \left( {^2\!\bm{B}} \dotp \hspace{-0.1ex} {^2\!\bm{B}} \right) = {^2\!\bm{B}} \dotdotp \hspace{-0.1ex} {^2\!\bm{B}} = B_{i\hspace{-0.1ex}j} B_{ji} }$
...
\vspace{-0.64em} При~различных собственных числах собственные векторы единичной длины~${\mathboldae_i}$ образуют ортонормальный базис. Каков\'
{ы}~же в~нём компоненты тензора?
...
\vspace{-0.25em} В~общем случае ${B_{i\hspace{-0.1ex}j} = \bm{e}_i \dotp {^2\!\bm{B}} \dotp \bm{e}_{\hspace{-0.1ex}j}}$, в~базисе~же ${\mathboldae_1}$, ${\mathboldae_2}$, ${\mathboldae_3}$ единичных взаимно ортогональных ${\mathboldae_i \dotp \mathboldae_{\hspace{-0.1ex}j} = \delta_{i\hspace{-0.1ex}j}}$ собственных осей симметричного тензора:
\[\begin{array}{c}
...
\noindent Матрица компонент диагональна и~${{^2\!\bm{B}} = \sum \hspace{-0.2ex} \eigenvalue_{\hspace{-0.15ex}i} \hspace{.1ex} \mathboldae_i \mathboldae_i}$. Здесь идёт суммирование по~трём повторяющися индексам, ведь используется особенный базис.
...
\tikzmark{BeginPaBrace} \bm{a} \hspace{.16ex} \dotp \tikzmark{BeginEBrace} \bm{P}^{\T} \tikzmark{EndPaBrace} \hspace{-0.4ex} \dotp \bm{P} \hspace{-0.32ex}\tikzmark{EndEBrace}\hspace{0.32ex} \dotp \hspace{.16ex} \bm{a} = \eigenvalue \bm{a} \dotp \eigenvalue \bm{a}
...
{\small\setlength{\abovedisplayskip}{2pt}\setlength{\belowdisplayskip}{2pt}
Соглашение о~суммировании обретает новые положения: повторяющиеся~(\inquotes{немые}) индексы суммирования расположены на~\hbox{разных} уровнях, а~свободные индексы в~обеих частях равенств\:--- на~одной высоте (${a_i = \hspace{0.1ex} b_{i\hspace{-0.1ex}j} c^{\hspace{0.2ex}j}}$\:--- корректно, ${a_i \hspace{-0.1ex} = \hspace{0.1ex} b_{kk}^{\hspace{0.1ex}i}}$\:--- дважды ошибочно).
\par}
...
\vspace{-0.1em} \noindent Коэффициент~$\gamma$ получился равным объёму параллелепипеда, построенного на~векторах~$\bm{a}_i$; в~\pararef{para:crossproduct+levicivita} тот~же объём был представлен как~\!${\sqrt{\hspace{-0.36ex}\mathstrut{\textsl{g}}}\hspace{0.16ex}}$, и~это неспроста, поскольку он совпадает с~квадратным корнем из~грамиана~\hbox{$\textsl{g} \hspace{0.1ex} \hspace{0.25ex} \equiv \hspace{0.2ex} \operatorname{det} \textsl{g}_{i\hspace{-0.1ex}j}$\hspace{-0.12ex}}\:--- определителя симметричной матрицы~\hbox{J.\,P.\,Gram’а}~${\textsl{g}_{i\hspace{-0.1ex}j} \hspace{-0.1ex} \hspace{0.16ex} \equiv \hspace{0.2ex} \bm{a}_i \dotp \bm{a}_j}$.
...
\vspace{0.2em} \noindent Произведение определителей~${\levicivita_{i\hspace{-0.1ex}jk} \levicivita_{pqr}}$ равно определителю произведения матриц, элементы последнего\:--- суммы вида ${\bm{a}_i \dotp \bm{e}_s \bm{e}_s \hspace{-0.2ex} \dotp \bm{a}_p \hspace{-0.12ex}= \bm{a}_i \dotp \bm{E} \dotp \bm{a}_p \hspace{-0.12ex}= \bm{a}_i \dotp \bm{a}_p}$ %%\hspace{0.1ex}:
\[
...
= \partial_i \hspace{.12ex} \bm{r}_{\hspace{-0.2ex}jk} %%\hspace{-0.4ex} = \partial_k \bm{r}_{i\hspace{-0.1ex}j}
\end{equation}
...
${\hspace{.1ex}\pmb{\scalebox{1.2}[1]{$\mathscr{R}$}} \hspace{-0.16ex} = \hspace{-0.2ex} {^2\bm{0}}}$ (в~компонентах это шесть уравнений ${\hspace{.1ex}\mathscr{R}^{\hspace{.1ex}i\hspace{-0.1ex}j} \hspace{-0.3ex} = \mathscr{R}^{\hspace{.1ex}ji} \hspace{-0.3ex} = 0}$) \en{is}\ru{есть} \en{necessary condition}\ru{необходимое условие} \en{of~integrability}\ru{интегрируемости}~(\ru{\inquotes{совместности}, }\inquotes{compatibility}) при определении вектора-радиуса~${\bm{r}(q^{\hspace{.1ex}k})}$ по~полю~${\textsl{g}_{i\hspace{-0.1ex}j}(q^{\hspace{.1ex}k})}$.

...
\integral\displaylimits_{\mathcal{V}} \hspace{-0.42ex} \Bigl( \hspace{-0.2ex} \kineticenergydensity + \potentialenergydensity \Bigr)^{\hspace{-0.2ex} \timederivativedot} \hspace{.1ex} d\mathcal{V} \hspace{.2ex}
= \hspace{-0.1ex}

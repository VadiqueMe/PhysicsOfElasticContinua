...
int main()
{
	...
	printf( "ratio*alpha = %.14f\n", ratio * alpha ) ;
	printf( "1/(ratio*alpha) = %.14f\n", (double)1 / ( ratio * alpha ) ) ;
	printf( "1/(ratio*alpha)^2 = %.14f\n", (double)1 / ( ratio * alpha * ratio * alpha ) ) ;
	printf( "3/(ratio*alpha)^2 = %.14f\n", (double)3 / ( ratio * alpha * ratio * alpha ) ) ;

	///printf( "(30/17)^2 + 3/(ratio*alpha)^2 = %.14f\n", ( (double)30 * (double)30 / ( (double)17 * (double)17 ) ) + (double)3 / ( ratio * alpha * ratio * alpha ) ) ;
	///printf( "sqrt[ (30/17)^2 + 3/(ratio*alpha)^2 ] = %.14f\n", sqrt(( (double)30 * (double)30 / ( (double)17 * (double)17 ) ) + (double)3 / ( ratio * alpha * ratio * alpha )) ) ;

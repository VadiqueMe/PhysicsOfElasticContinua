...
\draw [ axis with arrow, -{To[round, length=6pt, width=7pt]} ]
	( {-\radiusofcircle - .2*\yaxislinelength}, 0 )
	-- ++( {\radiusofcircle + .94*\yaxislinelength}, 0 )
	node [ pos=.98, below, shape=circle, inner sep=0pt, outer sep=6pt ]
		{\scalebox{.8}{$ y $}} ;

\draw [ axis with arrow, -{To[round, length=6pt, width=7pt]} ]
	( 0, {-\radiusofcircle - .2*\zaxislinelength} )
	-- ++( 0, {\radiusofcircle + .9*\zaxislinelength} )
...
\draw [ axis with arrow, -{To[round, length=6pt, width=7pt]} ]
	( {-.5*\widthofsquare - .3*\yaxislinelength}, 0 ) -- ++( {\widthofsquare + 1.1*\yaxislinelength}, 0 )
...
\draw [ axis with arrow, -{To[round, length=6pt, width=6pt]} ]
	( 0, 0 ) -- ++( 5.5*\axislength, 0 )
	node [ pos=.98, below, shape=circle, inner sep=0pt, outer sep=5pt ]
		{\scalebox{.8}{$ a $}} ;

\draw [ axis with arrow, -{To[round, length=6pt, width=6pt]} ]
	( 0, -1.5*\axislength ) -- ++( 0, 3.8*\axislength )
...
\draw [ aux line thin, rotate around={atan(-2):(0, 0)} ]
	...
	node [ pos=.84, right, shape=circle, inner sep=0pt, outer sep=4.4pt ]
		{\scalebox{.8}{$ \upsigma_{\hspace{-0.2ex}\scalebox{.8}{$x$}} \hspace{-0.4ex}=\hspace{-.25ex} 0 $}} ; % zero stress line

\draw [ axis with arrow, -{To[round, length=6pt, width=6pt]}, rotate around={atan(-2):(0, 0)} ]
	( 0, 0 ) -- ( -\widthofsquare, \heightofsquare )
	node [ pos=.99, left, shape=circle, inner sep=0pt, outer sep=6.6pt ]
		{\scalebox{.8}{$ c $}} ; % zero stress axis

\draw [ axis with arrow, -{To[round, length=6pt, width=6pt]}, rotate around={atan(-2):(0, 0)} ]
	( {-1.1*\widthofsquare}, {-1.1*(1/2)*\widthofsquare} ) -- ( {1.66*\widthofsquare}, {1.66*(1/2)*\widthofsquare} )
	node [ pos=1, below, shape=circle, inner sep=0pt, outer sep=2.2pt ]
		{\scalebox{.8}{$ d $}} ;

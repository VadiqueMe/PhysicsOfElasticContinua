...
%%\newcommand\textconst{\scalebox{0.92}[0.98]{\textsf{const}}}
...
\tikzset{pics/boldmeridiansecond/.style={code={
	...
	\draw [ line width=\ebeneKurveThickness, color=\ebeneKurveColor, opacity=\ebeneKurveOpacity
		...
		, postaction={decorate, decoration = {text along path,
			text align = {left indent = {0.84\dimexpr\pgfdecoratedpathlength\relax}},
			text format delimiters = {<}{>},
			text = {<\normalsize>{\scalebox{\enlargelesstext}{$\varphi = \const$}}},
			raise = 1.2ex}}
		]
		( 0, 3, 2.7 )
...
\tikzset{pics/paralleleConstCoodrinate/.style={code={
	...
	\draw [ line width=\paralleleThickness, color=\paralleleColor
		...
		, domain=0:\rotationangleto
		, postaction={decorate, decoration = {text along path,
			text align = {left indent = {0.42\dimexpr\pgfdecoratedpathlength\relax}},
			text format delimiters = {<}{>},
			text = {<\normalsize>{\scalebox{\enlargelesstext}{$s = \const$}}},
			%%reverse path,
			raise = 1.1ex}}
		]
		plot [ samples=\stepsofrotationsecond ] ( { \paralleleRadius*sin(\x) }, \paralleleXi, { \paralleleRadius*cos(\x) } ) ;
...
\begin{tikzpicture}[scale=1
	...
	node [below right, pos=0.65
		, inner sep=1pt, outer sep=1pt
		, shape=circle %%, fill=white
		] {\scalebox{\enlargetext}{$ \bm{r}\scalebox{\enlargeless}{$(\varphi, s)$} $}} ;
...
\\[.6em]
\bm{e}_{\xi} \hspace{-0.25ex} = \hspace{-0.1ex} \boldconst
\hspace{.1ex} , \:\:
...
\begin{equation*}\begin{array}{c}
\bm{r}(q^1 \hspace{-0.44ex}, q^{\hspace{.05ex}2}) \hspace{-0.2ex} = \bm{r}(\varphi, s) \hspace{-0.2ex}
= \xi(s) \hspace{.1ex} \bm{e}_{\xi} + \rho\hspace{.1ex}(s) \hspace{.2ex} \bm{e}_{\hspace{-0.1ex}\rho}(\varphi)
\\[.3em]
\bm{r} = \xi \bm{e}_{\xi} + \rho \hspace{.15ex} \bm{e}_{\hspace{-0.1ex}\rho}
\end{array}\end{equation*}

\begin{equation*}\begin{array}{c}
\bm{r}_1 \hspace{-0.2ex} = \partial_1 \hspace{-0.1ex} \bm{r}
= \partial_{\hspace{-0.1ex}\varphi} \bm{r}
= \scalebox{.85}{$ \displaystyle\frac{\raisemath{-0.15em}{\partial \hspace{.1ex} \bm{r}}}{\partial \varphi} $}
...
\\[.8em]
%
\bm{r}_2 \hspace{-0.2ex} = \partial_2 \bm{r}
= \partial_{\hspace{-0.2ex}s} \bm{r}
= \scalebox{.85}{$ \displaystyle\frac{\raisemath{-0.15em}{\partial \hspace{.1ex} \bm{r}}}{\partial s} $}
...
\begin{equation*}\begin{array}{c}
\bm{r}^1 \hspace{-0.25ex} = \rho^{\hspace{-0.2ex}\expminusone} \hspace{-0.1ex} \bm{e}_{\varphi}
\\[.25em]
\bm{r}^2 \hspace{-0.2ex} = \hspace{.1ex} \bm{t}
\end{array}\end{equation*}

\vspace{-0.5em}
\begin{equation*}\begin{array}{c}
\bm{r}_3 \hspace{-0.2ex} = \bm{r}^3 \hspace{-0.24ex}
= \bm{n}
...
\begin{tikzpicture}[scale=\scaleofunits]
	...
	\draw [line width=0.6pt, color=blue, line cap=round]
		( 0, 0 ) -- ( \dxilength, 0 )
	node [pos=0.57, below, inner sep=0pt, outer sep=2.5pt] {$ d \xi $} ;

	\draw [line width=0.6pt, color=blue, line cap=round]
		( \dxilength, 0 ) -- ( \dxilength, \drhomultiplier*\dxilength )
	node [pos=0.52, right, inner sep=0pt, outer sep=2pt] {$ d \hspace{-0.16ex} \rho $} ;

	\draw [line width=1.2pt, color=black, domain=0:\dxilength, line cap=round, mark position=0.66(fornode)]
		plot [samples=100] (\x, {\drhomultiplier*sin(deg(\x))}) ;
	\node at (fornode) [black, below right, inner sep=0pt, outer sep=1.6pt]
		{$ \scalebox{.66}{$\Delta$} s $} ;

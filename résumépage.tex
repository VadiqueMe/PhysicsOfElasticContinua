\newcommand\resumename{\en{Introduction}\ru{Введение}}
\chapter*{\resumename}
...
\en{all the models}\ru{все модели}
...
\en{oscillations, waves and a~stability}\ru{колебания, волны и устойчивость}.
...
\en{The~destruction dynamics}\ru{Динамика разрушения}
...
\en{of the~human-made}\ru{сделанных человеком}
\en{inhomogeneous materials}\ru{неоднородных материалов}
(\en{the~}\inquotes{\en{composites}\ru{композитов}})\en{ are also shown}.
...
\en{but}\ru{но}
\en{as}\ru{как}
\en{a~continuous}\ru{непрерывное}
\en{field}\ru{поле}
\en{of location vectors}\ru{векторов положения},
\en{a~continuous}\ru{непрерывная}
...
\en{of }\ru{бесконечно м\'{а}лых}
\en{can be used}\ru{может быть использован}
\en{for}\ru{для}
\en{such a~model}\ru{такой модели}.

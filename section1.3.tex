...
\en{of second complexity}\ru{второй сложности}
( \en{of second valence}\ru{второй валентности},
\en{bivalent}\ru{ бивалентный} ).

\en{In other words}\ru{Иными словами},
\en{tensor}\ru{тензор}~$\somebivalenttensor$
\en{reveals in every basis as a~collection of its components}\ru{проявляется в~каждом базисе совокупностью своих компонент}~$\somebivalenttensorcomponents{i\hspace{-0.1ex}j}$, \en{changing along with a~basis according to}\ru{меняющейся вместе с~базисом согласно}~\eqref{orthotransform:2}.
...
\en{The~essential exemplar}\ru{Существенным экземпляром}
\en{of a~bivalent tensor}\ru{двухвалентного тензора}
\ru{является}\en{is}

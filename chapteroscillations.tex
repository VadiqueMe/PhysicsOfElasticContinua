...
\vspace{.2em}
\en{According to the common theory}\ru{Согласно общей теории}~(\chapterdotsectionref{chapter:genericmechanics}{section:smalloscillations}), \en{we begin}\ru{мы начинаем} \en{with the analysis}\ru{с~анализа} \en{of~harmonics}\ru{гармоник}~(\en{ortho\-gonal oscillations}\ru{орто\-гональ\-ных колебаний}):

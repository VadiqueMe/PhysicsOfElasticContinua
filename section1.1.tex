...
{\small
\foreignlanguage{russian}{У~сам\'{и}х по~себе векторов
как элементов векторного пространства
компонент нет.
Компоненты у~вектора появляются лишь тогда, когда мы выбрали базис.
...
For this purpose, the unit vectors
...
\en{of a~pairwise perpendicular}\ru{попарно перпендикулярных}

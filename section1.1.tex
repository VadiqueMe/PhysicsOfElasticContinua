\en{\section{\en{Vector}\ru{Вектор}}}
...
\en{There are also pseudovectors}\ru{Бывают ещё и~псевдовекторы}, \en{waiting for the~reader}\ru{ждущие читателя} \en{below}\ru{ниже} \en{in}\ru{в}~\sectionref{para:crossproduct}.}\hbox{\hspace{-0.5ex}.
\par}

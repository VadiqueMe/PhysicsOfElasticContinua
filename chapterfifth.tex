...
\vspace{-0.5em} \en{Force stress tensor}\ru{Тензор силового напряжения}~$\forcestresstensor$ удовлетворяет тем~же дифференциальным \inquotes{уравнениям равновесия}\footnote{%
...
eccentricity vector~$\mathboldoe$
...
%% to describe such a material, even when assumed to be linear elastic, homogeneous and isotropic, it requires six independent material constants, in contrast to only two such constants for the classical continuum

...

material’s intrinsic (internal) length scale $h$

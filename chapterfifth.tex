...
% псевдоконтину\kern-0.11exум, или модель со~стеснённым вращением (constrained rotation)
...
\boldnabla \hspace{-0.1ex} \dotp \forcestresstensor + \bm{f} \hspace{.12ex} = \hspace{.1ex} \bm{0} \hspace{.1ex} ,
\:\;
\boldnabla \dotp \couplestresstensor \hspace{.1ex} + \forcestresstensor_{\Xcompanion} \hspace{-0.1ex} + \bm{m} \hspace{.1ex} = \hspace{.1ex} \bm{0} \hspace{.1ex} ,
\end{equation}
...
material’s intrinsic (internal) length scale $\hcursive$

Если устремить $\hcursive$ к~нулю, то исчезает вклад $\wrynesstensor$ в~$\Pi$, а~с~ним и моментные напряжения~$\couplestresstensor$.

...
(\chapref{chapter:nonlinearcontinuum}
...
\en{et~al.}\ru{и~др.}\:--- \chapdotpararef{chapter:genericmechanics}{para:statics}),
справедливые
\en{for}\ru{для}
\en{the continual}\ru{континуальных}
\en{linear elastic media}\ru{линейных упругих сред}~(\chapref{chapter:linearclassicalelasticity}),

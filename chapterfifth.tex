...
\inquotes{\en{elastic}\ru{упругое}}
...
\en{the~geometrically linear material}\ru{геометрически линейный материал},
...
Соотношения~\eqref{micropolar.constitutiveequations}
обращаются преобразованием Лежандра
...
\en{of~degrees o’freedom}\ru{степеней свободы}~(\chapterdotsectionref{chapter:genericmechanics}{section:statics}),

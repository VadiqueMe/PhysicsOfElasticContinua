...
\en{of a~classical continuum}\ru{классического контину\kern-0.11exума}
\en{has}\ru{имеет}
\en{only}\ru{лишь}
...
\en{of the }\ru{контину\kern-0.11exума }Cosserat\en{’s}\en{ continuum}
\en{is}\ru{есть}
...
\en{the bodies}\ru{тела}
\en{are composed}\ru{сделаны}

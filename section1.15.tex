...
\begin{wrapfigure}[19]{R}{.48\textwidth}
...
\en{But perhaps}\ru{Но авось},
\en{in addition to}\ru{вдобавок к}~${\bm{a}_i}$,
\en{there’s another}\ru{есть ещё другая}\:---
\en{the~}\inquotes{\en{superscript}\ru{надстрочная}}
...
\vspace{-0.3em}\noindent
\en{In this case}\ru{В~таком случае},
...
обратную матрице Gram\ru{’а}~${\textsl{g}_{i\hspace{-0.1ex}j}}$.

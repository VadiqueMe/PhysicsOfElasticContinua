...
\en{Geometrically linear model: displacements are small. Operators ${\hspace{-0.2ex}\boldnablacircled\hspace{.1ex}}$ and~${\hspace{-0.2ex}\boldnabla\hspace{.1ex}}$ are indistinguishable: \inquotesx{equations can~be written in the~reference configuration}[.]}

\ru{Геометрически линейная модель: перемещения м\'{а}лые. Операторы ${\hspace{-0.2ex}\boldnablacircled\hspace{.1ex}}$ и~${\hspace{-0.2ex}\boldnabla\hspace{.1ex}}$ неразличимы: \inquotesx{уравнения можно пис\'{а}ть в~отсчётной конфигурации}[.]}
...
\en{Paradox of elastostatics}\ru{Парадокс эластостатики}

Накопленная потенциальная энергия деформации равна всего половине работы внешних сил.

Accumulated potential energy of deformation accounts for (is equal to) only half the~work done by the~external forces, acting through displacements from the~unstressed configuration to the~equilibrium.

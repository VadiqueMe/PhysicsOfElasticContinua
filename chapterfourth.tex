...
$\mathboldepsilon$\ru{\:---}\en{~is} \en{linear deformation tensor}\ru{тензор линейной деформации},
${\Pi(\hspace{-0.1ex}\mathboldepsilon\hspace{-0.1ex})\hspace{-0.1ex}}$\ru{\:---}\en{~is} \en{elastic energy of~deformation per volume unit}\ru{упругая энергия деформации единицы объёма},
${\stiffnesstensor}$\ru{\:---}\en{~is} \en{stiffness tensor}\ru{тензор жёсткости} (\en{tetravalent}\ru{четырёхвалентный}, \en{with symmetry}\ru{с~симметрией} ${\stiffnesstensor_{\hspace{.12ex} 12 \scalebox{0.6}[0.8]{$\rightleftarrows$} 34} \hspace{-0.25ex} = \hspace{-0.1ex} \stiffnesstensor}$\hbox{\hspace{.1ex},} ${\stiffnesstensor_{\hspace{.12ex} 1 \scalebox{0.6}[0.8]{$\rightleftarrows$} 2} \hspace{-0.25ex} = \hspace{-0.1ex} \stiffnesstensor}$\hbox{\hspace{.1ex},} ${\stiffnesstensor_{\hspace{.12ex} 3 \scalebox{0.6}[0.8]{$\rightleftarrows$} 4} \hspace{-0.25ex} = \hspace{-0.1ex} \stiffnesstensor}$).

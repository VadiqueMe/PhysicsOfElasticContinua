...
\boldnabla \dotp \mathboldtau \hspace{.15ex} + \bm{f} = \hspace{.1ex} \bm{0} \hspace{.1ex}, \:\:
\mathboldtau = \scalebox{0.92}[0.92]{$ \displaystyle \frac{\raisemath{-0.125em}{\partial\hspace{.1ex} \Pi^{\mathstrut}}}{\partial \mathboldepsilon}$} = \stiffnesstensor \dotdotp \mathboldepsilon , \:\:
...
\en{Here}\ru{Здесь}
$\mathboldtau$\ru{\:---}\en{~is} \en{stress tensor}\ru{тензор напряжения},
...
\en{Equations}\ru{Уравнения}~\eqref{lineartheory:wholesetofequations} \en{are exact}\ru{точные}, \en{they can be obtained via variation}\ru{они могут быть получены варьированием} \en{of equations of the~nonlinear theory}\ru{уравнений нелинейной теории}.
...
\:\;
\variation{\hspace{.12ex}\bm{C}} = \hspace{-0.2ex} \boldnabla \hspace{.12ex} \variation{\bm{R}}^{\hspace{.2ex}\mathsf{S}} \hspace{-0.2ex}
...
$\varbivalent{\hspace{-0.16ex}\cauchystress}$ \en{to}\ru{на}~$\mathboldtau$,
${\scalebox{0.95}[0.95]{$\raisemath{.16em}{\scalebox{0.92}[0.92]{$\partial^2 \hspace{.1ex} \Pi$}} / \hspace{-0.1ex} \raisemath{-0.32em}{\scalebox{0.92}[0.92]{$\partial \hspace{.1ex} \bm{C} \hspace{.1ex} \partial \hspace{.1ex} \bm{C}$}}\hspace{.12ex}$}}$ \en{to}\ru{на}~$\stiffnesstensor$,
\en{and}\ru{а}~${\hspace{-0.1ex} \rho \hspace{.25ex} \variation{\hspace{-0.2ex}\bm{f}}}$ \en{to}\ru{на}~${\hspace{-0.1ex} \bm{f}}$ \hbox{\hspace{-0.2ex}.}
...
\nopagebreak\vspace{-0.2em}\begin{equation}\label{nonlinear:setofequations}
\begin{array}{c}
\boldnabla \dotp \mathboldtau \hspace{.15ex} + \rho \bm{f} = \hspace{.1ex} \bm{0} \hspace{.1ex}, \:\:
...
\\[.2em]
\mathboldtau \hspace{.1ex} = J^{-1} \hspace{0.2ex} \bm{F} \dotp \displaystyle \frac{\partial\hspace{.1ex} \Pi}{\partial\hspace{.1ex} \bm{C}} \dotp \bm{F}^{\hspace{.1ex}\T} \hspace{-0.4ex}, \:\:
...
\begin{array}{c}
\mathboldtau \hspace{.1ex} = \mathboldtau^{\hspace{0.2ex}\scalebox{0.66}[0.66]{(0)}} \hspace{-0.2ex} + \smallparameter \mathboldtau^{\hspace{0.2ex}\scalebox{0.66}[0.66]{(1)}} \hspace{-0.1ex} + \ldots \hspace{.1ex}, \:\:
...
\noindent Для первых~(\inquotes{нулевых}) членов этих разложений и~получается~\eqref{lineartheory:wholesetofequations}. В~\hbox{книге~\cite{truesdell-firstcourse}} си\'{е} названо \inquotesx{формальным приближением}[.]
...
Но встречаются и~более сложные комбинации, если знаем одно\-времен\-но некоторые компоненты как~$\bm{u}$, так~и~${\mathboldtau_{\hspace{-0.1ex}n} \hspace{-0.25ex} = \bm{n} \dotp \mathboldtau}$. Для примера, на~плоской грани~${x = \constant}$ при~вдавливании штампа с~гладкой поверхностью ${u_x \hspace{-0.32ex} = v (y , \hspace{-0.1ex} z)}$, ${\mathtau_{xy} \hspace{-0.2ex} = \mathtau_{xz} \hspace{-0.2ex} = 0}$ (функция~$v$ определяется формой штампа).

Начальные условия в~динамических задачах, когда вместо~$\bm{f}$ имеем ${\bm{f} \hspace{-0.1ex} - \hspace{-0.1ex} \rho \hspace{.1ex} \mathdotdotabove{\bm{u}}}$, ставятся как обычно в~механике\:--- на~положения и~на~скорости: в~условный момент времени~${t \!=\! 0}$ определены~$\bm{u}$ и~$\mathdotabove{\bm{u}}$.

Как отмечалось в~\chapref{chapter:genericmechanics}, в~основу механики может быть положен принцип виртуальной работы~(\hbox{d’\hspace{-0.2ex}Alembert--Lagrange} principle). Этот принцип справедлив и~в~линейной теории (внутренние силы в~упругой среде потенциальны: ${\variation{\internalwork} = -\variation{\Pi}}$)

\nopagebreak\vspace{-0.2em}\begin{equation}\label{lineartheory:principleofvirtualwork}
\integral\displaylimits_{\mathcal{V}} \hspace{-0.4ex} \left[^{\mathstrut} \hspace{-0.2ex} \left( \bm{f} \hspace{-0.1ex} - \hspace{-0.1ex} \rho \hspace{.1ex} \mathdotdotabove{\bm{u}} \hspace{0.2ex} \right) \dotp \variation{\bm{u}} - \variation{\Pi} \hspace{0.25ex} \right] \hspace{-0.32ex} d\mathcal{V} + \hspace{-0.2ex}
\integral\displaylimits_{o_2} \hspace{-0.25ex} \bm{p} \dotp \variation{\bm{u}} \hspace{.25ex} do \hspace{.2ex}
= \hspace{.1ex} 0 \hspace{.1ex},
\:\:
\bm{u} \hspace{.1ex} \bigr|_{o_1} \hspace{-0.64ex} = \hspace{.1ex} 0
\hspace{.1ex},
\end{equation}
...
= \mathboldtau \dotdotp \hspace{-0.12ex} \boldnabla \variation{\bm{u}}^{\hspace{.1ex}\mathsf{S}} \hspace{-0.16ex}
= \boldnabla \hspace{-0.1ex} \dotp \left( \hspace{.1ex} \mathboldtau \hspace{-0.1ex} \dotp \variation{\bm{u}} \hspace{.1ex} \right) - \boldnabla \dotp \mathboldtau \dotp \variation{\bm{u}} \hspace{.1ex},
\\[.4em]
%
...
\[
\integral\displaylimits_{\mathcal{V}} \hspace{-0.5ex} \left(^{\mathstrut} \hspace{-0.2ex} \boldnabla \dotp \mathboldtau \hspace{.12ex} + \bm{f} \hspace{-0.1ex} - \hspace{-0.1ex} \rho \hspace{.1ex} \mathdotdotabove{\bm{u}} \hspace{0.25ex} \right) \hspace{-0.32ex} \dotp \variation{\bm{u}} \hspace{0.25ex} d\mathcal{V} + \hspace{-0.2ex}
\integral\displaylimits_{o_2} \hspace{-0.5ex} \left(^{\mathstrut} \bm{p} - \bm{n} \dotp \mathboldtau \right) \hspace{-0.32ex} \dotp \variation{\bm{u}} \hspace{.25ex} do
\hspace{.1ex} ,
\]

\vspace{-0.4em} \noindent что, конечно~же, равно нулю. Отметим краевое условие ${\bm{u} \hspace{.1ex} \bigr|_{o_1} \hspace{-0.64ex} = \hspace{0.2ex} 0}$: виртуальные перемещения согласованы с~этой связью\:--- ${\variation{\bm{u}} \hspace{.1ex} \bigr|_{o_1} \hspace{-0.64ex} = \hspace{0.2ex} 0}$.
...
Как~обычно в~линейной математической физике~\cite{lurie-theoryofelasticity, tihonovsamarsky-mathphysicsequations}, теорема единственности доказывается от~противного. Допустим, что есть два решения: ${\bm{u}_1 (\bm{r}, t)}$ и~${\bm{u}_2 (\bm{r}, t)}$. Составим разность~${\bm{u}^{\hspace{-0.1ex}*} \hspace{-0.2ex} \equiv \hspace{.12ex} \bm{u}_1 \hspace{-0.32ex} - \bm{u}_2}$ и~докажем, что она равна нулю.
...
\integral\displaylimits_{o_2} \hspace{-0.32ex} \bm{p} \dotp \mathdotabove{\bm{u}} \hspace{.25ex} do \hspace{.1ex},
\:\:
\bm{u} \hspace{.1ex} \bigr|_{o_1} \hspace{-0.64ex} = \hspace{.2ex} 0
\hspace{.1ex} .
\end{equation}
...
= \mathboldtau \hspace{.1ex} \dotdotp \hspace{-0.12ex} \boldnabla \mathdotabove{\bm{u}}^{\hspace{.1ex}\mathsf{S}} \hspace{-0.12ex} =
\boldnabla \hspace{-0.1ex} \dotp \left( \hspace{.1ex} \mathboldtau \dotp \mathdotabove{\bm{u}} \hspace{.1ex} \right) -
\tikzmark{NablaDotTauDynamicsBegin} \boldnabla \dotp \mathboldtau \tikzmark{NablaDotTauDynamicsEnd} \dotp \mathdotabove{\bm{u}}
\hspace{.1ex} .
\end{array}\]%
...
{${\scalebox{0.75}{$ - \hspace{.2ex} (\hspace{.12ex} \bm{f} \hspace{-0.2ex} - \hspace{-0.2ex} \rho \hspace{.1ex} \mathdotdotabove{\bm{u}} \hspace{.12ex}) $}}$}

\vspace{.66em} \noindent Применяя теорему о~дивергенции и~используя уравнение баланса импульса ${\hspace{-0.24ex}\boldnabla \dotp \mathboldtau \hspace{.15ex} + \bm{f} - \rho \hspace{.1ex} \mathdotdotabove{\bm{u}} \hspace{.1ex} = 0}$ и~краевое условие ${\bm{n} \dotp \mathboldtau = \bm{p}}$ на~$o_2$, убеждаемся, что~\eqref{dynamicsoflineartheory:integralofenergy} удовлетворено.
...
\:\,\Rightarrow\,\:
\mathdotabove{\bm{u}} = 0 \hspace{.1ex}, \; \mathboldepsilon = \hspace{-0.25ex} \boldnabla {\bm{u}}^{\hspace{.1ex}\mathsf{S}} \hspace{-0.2ex} = 0
\:\,\Rightarrow\:
...
\nopagebreak\vspace{-2.4em} ${\small \mathboldtau \hspace{.1ex} = \displaystyle \frac{\raisemath{-0.2em}{\partial\hspace{.1ex} \Pi}}{\raisemath{.04em}{\partial \mathboldepsilon}} = \stiffnesstensor \dotdotp \mathboldepsilon = \mathboldepsilon \dotdotp \stiffnesstensor}$ \nopagebreak\vspace{.55em}
...
A^{i\hspace{-0.1ex}jkl} \hspace{.16ex} \bm{r}_i \bm{r}_j \bm{r}_k \bm{r}_l
\hspace{.1ex} , \:\:
%
A^{i\hspace{-0.1ex}jkl} \hspace{-0.16ex} =
\displaystyle \frac{\partial^2 \hspace{.1ex} \Pi}{\raisemath{-0.1em}{\partial \varepsilon_{i\hspace{-0.1ex}j} \hspace{.1ex} \partial \varepsilon_{kl}}} \hspace{.16ex}.
\end{equation}

\begin{comment} %%
\[\scalebox{0.8}{$\begin{array}{c}
\scalebox{1.2}{$A^{abcd} = A^{cdab}$} \\[.2em]
%
A^{1112} = A^{1211} \\
A^{1113} = A^{1311} \\
A^{1121} = A^{2111} \\
...
${\stiffnesstensor_{\hspace{.12ex} 12 \scalebox{0.6}[0.8]{$\rightleftarrows$} 34} \hspace{-0.25ex} = \hspace{-0.1ex} \stiffnesstensor \hspace{.5ex} \Leftrightarrow \hspace{.2ex} A^{i\hspace{-0.1ex}jkl} \hspace{-0.17ex} = A^{kli\hspace{-0.1ex}j}\hspace{-0.25ex}}$,
от~этого у~36 компонент из~${3^4 \hspace{-0.25ex} = \hspace{-0.12ex} 81}$ \inquotesx{есть двойн\'{и}к}[,] а~лишь~45 независимы. К~тому~же, из\hbox{-}за симметрии тензора линейной деформации~$\mathboldepsilon$, тензор~$\stiffnesstensor$ симметричен ещё~и~внутри каждой пары индексов: ${A^{i\hspace{-0.1ex}jkl} \hspace{-0.16ex} = A^{jikl} \hspace{-0.16ex} = A^{i\hspace{-0.1ex}jlk}}$~(${= A^{jilk}}$). Число независимых компонент при~этом снижается до~21:

\nopagebreak\vspace{-0.25em}\begin{equation*}\scalebox{0.8}{$\begin{array}{l}
\scalebox{1.16}{$A^{abcd^{\mathstrut}} = A^{cdab} = A^{bacd} = A^{abdc}$} \\[.2em]
%
A^{1111} \\
...
Пусть далее плоскостей симметрии две: ${z = \constant}$ и~${y = \constant}$. Поскольку~$\Pi$ не~чувствительна к~знакам~$\varepsilon_{yx}$ и~$\varepsilon_{yz}$, вдобавок к~\eqref{zeroconstants:oneplaneofsymmetry} имеем
...
${\mathboldepsilon = \displaystyle \frac{\raisemath{-0.2em}{\partial\hspace{.1ex} \widehat{\Pi}}}{\raisemath{.04em}{\partial \mathboldtau}} = \pliabilitytensor \dotdotp \mathboldtau \hspace{.1ex} = \mathboldtau \dotdotp \hspace{-0.1ex} \pliabilitytensor}$

\[
\widehat{\Pi}(\hspace{-0.1ex}\mathboldtau\hspace{.12ex}) \hspace{-0.1ex}
= \mathboldtau \dotdotp \mathboldepsilon
- \hspace{.1ex} \Pi(\mathboldepsilon) %%\hspace{-0.1ex}
\]
...
\hspace{2.25ex}
2 \hspace{.1ex} \Pi \hspace{.1ex} = \mathboldtau \dotdotp \mathboldepsilon =
\mathboldtau \hspace{.1ex} \dotdotp \hspace{-0.12ex} \boldnabla \bm{u}^{\mathsf{S}} \hspace{-0.12ex} =
\boldnabla \hspace{-0.1ex} \dotp \left( \hspace{.1ex} \mathboldtau \dotp \bm{u} \hspace{.1ex} \right) -
\tikzmark{beginMinusLoad} \boldnabla \dotp \mathboldtau \tikzmark{endMinusLoad} \dotp \bm{u} \;\Rightarrow
\\[.5em]
%
\Rightarrow\;\,
\displaystyle 2 \hspace{-0.16em}
\integral\displaylimits_{\mathcal{V}} \hspace{-0.5ex} \Pi \hspace{0.2ex} d\mathcal{V} \hspace{.12ex} =
\integral\displaylimits_{o_2} \hspace{-0.4ex} \tikzmark{beginSurfaceLoad} \bm{n} \dotp \mathboldtau \tikzmark{endSurfaceLoad} \hspace{.1ex} \dotp \bm{u} \hspace{.25ex} do \hspace{.4ex} +
\integral\displaylimits_{\mathcal{V}} \hspace{-0.4ex} \bm{f} \hspace{-0.1ex} \dotp \bm{u} \hspace{.25ex} d\mathcal{V}
\hspace{2.25ex}
...
\vspace{-0.2em} Из~\eqref{clapeyron:elasticitytheorem} следует, что без нагрузки
${\hspace{-0.25ex}\scalebox{1.4}{$\integral$}_{\hspace{-0.5ex}\raisemath{.1em}{\mathcal{V}}} \hspace{.25ex} \Pi \hspace{.2ex} d\mathcal{V} = 0}$.
По\-сколь\-ку $\Pi$ положительна, то и напряжение~$\mathboldtau$, и~деформация~$\mathboldepsilon$ без нагрузки\:--- нулевые.

\textbf{\en{Paradox of elastostatics}\ru{Парадокс эластостатики}}: ${\Pi}$ \en{is equal to}\ru{равна} \en{only}\ru{лишь} \en{the~half}\ru{половине} \en{of~the~work}\ru{работы} внешних сил.
...
{\small
\en{Clapeyron’s theorem, taken literally, implies that the accumulated elastic energy accounts for only the~half of the energy spent to load the body; the remaining half of the work done to the body by the external forces is unaccounted for and is lost somewhere in reaching the equilibrium.}

\ru{Теорема Clapeyron’а, взятая буквально, подразумевает, что запасённая упругая энергия составляет только половину энергии, потраченной на деформацию тела; оставшаяся половина работы, совершённой над телом внешними силами, не учитывается и теряется где-то по достижении равновесия.}
\par}

{\small
\en{This apparent paradox is reached within the framework of purely conservative linear elasticity. Alternatively, however, within elastostatics the common characterization of the work done to reach equilibrium is conceptually ambiguous, and a novel interpretation may be needed.}

\ru{Этот кажущийся парадокс достигается в рамках чисто консервативной линейной упругости. В качестве альтернативы, однако, в эластостатике общая характеристика работы, совершённой для достижения равновесия, концептуально неоднозначна, и может быть нужна новая интерпретация.}
...
Для решения парадокса в~теории распространена концепция \inquotes{бесконечно медленного постепенного статического нагружения} (\inquotes{infinitely slow gradual application of the load}).

{\small
Статика рассматривает \inquotes{замороженное} равновесие, оно вне времени. Динамика~же нагружения до~равновесия это предыстория. В~линейной теории в~равновесии работа внешних сил на актуальных перемещениях, затраченная на~деформацию, равна удвоенной внутренней потенциальной энергии деформации. \inquotes{Запасается} всего половина потраченной энергии. Вторая половина это дополнительная энергия, она теряется до~обретения равновесия на~динамику\:--- на~кинетическую энергию частиц (на \inquotes{диссипацию}), на~колебания и~волны. Так в~теории. Однако, в~реальности не~бывает ни~моментального \inquotes{мёртвого} нагружения, ни~бесконечно медленного \inquotes{следящего}. Это две крайности. Реальная динамика нагружения всегда где\hbox{-}то между ними. Посему теоретическая дополнительная энергия всегда больше той реальной \inquotes{диссипативной} кинетической, которая сопутствовала процессу нагружения, и~в~линейной теории она численно равна упругому потенциалу\:--- половине работы внешних сил, той самой второй половине.
...
\en{Imagine}\ru{Вообразим} \en{straight}\ru{прямой} \en{rod}\ru{стержень}, закреплённый на~одном конце и~сжатый продольной силой на~другом~(\figref{fig:deformedrod}). Когда нагрузка достаточно больш\'{а}я, задача статики имеет два решения\:--- \inquotes{прямое} и \inquotesx{изогнутое}[.]
...
Для т\'{е}ла с~закреплением на~части поверхности~${o_1}$ рассматриваются два варианта: первый с~нагрузками $\bm{f}_1$, $\bm{p}_1$ и~второй с~нагрузками $\bm{f}_2$, $\bm{p}_2$. Словесная формулировка теоремы та~же, что и~в~\chapdotpararef{chapter:genericmechanics}{para:statics}. Метаматическая запись
...
\en{\section{Determining displacements by deformations}}
...
\boldnabla \dotp \mathboldtau \hspace{.15ex} + \bm{f} = \hspace{.1ex} \bm{0}
\end{equation}
...
\nopagebreak\vspace{-0.1em}\begin{equation}
\textit{Э} \hspace{.16ex} (\hspace{-0.1ex}\bm{u}\hspace{-0.1ex}) \equiv \hspace{-0.2ex}
...
- \hspace{-0.2ex}
\integral\displaylimits_{o_2} \hspace{-0.32ex} \bm{p} \dotp \bm{u} \hspace{.25ex} do \hspace{0.2ex}
...
\integral\displaylimits_{o_2} \hspace{-0.32ex} \bm{p} \dotp ( \bm{u}' \hspace{-0.2ex} - \bm{u} ) \hspace{.25ex} do \hspace{.1ex}
=
\ointegral\displaylimits_{\mathclap{o\hspace{.15ex}(\boundary \mathcal{V})}} \hspace{-0.2ex} \bm{n} \dotp \mathboldtau \hspace{.12ex} \dotp ( \bm{u}' \hspace{-0.2ex} - \bm{u} ) \hspace{.25ex} do \hspace{.1ex}
= \hspace{-0.1ex}
...
\mathboldtau \dotdotp \hspace{-0.16ex} \boldnabla {\bm{u}}^{\hspace{0.08ex}\mathsf{S}} \hspace{-0.2ex} - \hspace{.1ex} \widehat{\Pi}(\hspace{-0.1ex}\mathboldtau\hspace{.1ex})\hspace{-0.1ex} -
...
\hfil \variation{\mathcal{W}} \hspace{.1ex} (\bm{u}, \hspace{-0.32ex}\mathboldepsilon, \hspace{-0.32ex}\mathboldtau) = 0
\hspace{.1ex} ,
\\[-0.1em]
%
...
\integral\displaylimits_{\mathcal{V}} \hspace{-0.4ex}
\left[^{\mathstrut} \hspace{-0.2ex}
\mathboldtau \dotdotp \hspace{-0.4ex} \left( \hspace{-0.2ex} \boldnabla {\bm{u}}^{\hspace{0.08ex}\mathsf{S}} \hspace{-0.2ex} - \mathboldepsilon \hspace{-0.1ex} \right) \hspace{-0.25ex} + \hspace{.1ex} \Pi(\hspace{-0.1ex}\mathboldepsilon\hspace{-0.1ex})\hspace{-0.1ex} -
\bm{f} \hspace{-0.1ex} \dotp \bm{u}
\hspace{.1ex} \right] \hspace{-0.32ex} d\mathcal{V} \hspace{.5ex} - \hfill} \\[-1.2em]
%

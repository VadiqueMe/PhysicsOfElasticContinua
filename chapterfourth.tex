...
% https://en.wikipedia.org/wiki/Beno%C3%AEt_Paul_%C3%89mile_Clapeyron
...
\en{The~complete set}\ru{Полный набор}~(\en{system}\ru{система}) \en{of~equations}\ru{уравнений} \en{of~classical linear theory}\ru{классической линейной теории} \en{in~direct invariant tensor notation}\ru{в~прямой инвариантной тензорной з\'{а}писи}\ru{:}\en{ is}

\nopagebreak \ru{\vspace{-0.3em}}
...
\en{Equations}\ru{Уравнения}~\eqref{lineartheory:wholesetofequations} \en{are exact}\ru{точные}, \en{they can be obtained via variation}\ru{они могут быть получены варьированием} \en{from the~nonlinear theory}\ru{из~нелинейной теории}.
\en{Variation from arbitrary configuration}\ru{Варьирование от~произвольной конфигурации} \en{is~described in}\ru{описано в}~\chapdotpararef{chapter:nonlinearcontinuum}{para:variationofconfiguration}.
\en{The~linear theory}\ru{Линейная теория}\ru{\:---}\en{ is} \en{the~result of variation}\ru{результат варьирования} \en{from unstressed initial configuration}\ru{от~ненапряжённой начальной конфигурации}.
\en{There}\ru{При~этом}

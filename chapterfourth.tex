...
\mathboldtau = \displaystyle \frac{\partial\hspace{.1ex} \Pi^{\mathstrut}}{\partial \mathboldepsilon} = \stiffnesstensor \dotdotp \mathboldepsilon , \:\:
...
\noindent \en{It remains to~change}\ru{Остаётся поменять} ${\variation{\bm{R}}}$ \en{to}\ru{на}~$\bm{u}$, $\varbivalent{\hspace{-0.2ex}\cauchystress}$ \en{to}\ru{на}~$\mathboldtau$, ${\scalebox{0.98}[1]{$\raisemath{0.16em}{\scalebox{0.92}[0.92]{$\partial^2 \hspace{0.1ex} \Pi$}} / \hspace{-0.1ex} \raisemath{-0.32em}{\scalebox{0.92}[0.92]{$\partial \hspace{0.1ex} \bm{C} \hspace{0.1ex} \partial \hspace{0.1ex} \bm{C}$}}\hspace{0.12ex}$}}$ \en{to}\ru{на}~$\stiffnesstensor$, \en{and}\ru{а}~${\rho \hspace{.25ex} \variation{\hspace{-0.2ex}\bm{f}}}$ \en{to}\ru{на}~$\bm{f}$\hbox{\hspace{-0.2ex}.}
...
\inquotes{\en{Paradox of elastostatics}\ru{Парадокс эластостатики}}

Накопленная потенциальная энергия деформации равна всего половине работы внешних сил.

{\small
\en{Clapeyron’s theorem, taken literally, implies that the elastic stored energy accounts for only half of the energy spent to load the body; the remaining half of the work done to the body by the external forces is unaccounted for and is lost somewhere in reaching the equilibrium.}
...
Для решения парадокса в~теории распространена концепция \inquotes{бесконечномедленного постепенного статического нагружения} (\inquotes{infinitely slow gradual application of the load}).

{\small
Статика рассматривает \inquotes{замороженное} равновесие, оно вне времени. Динамика~же нагружения до~равновесия это предыстория. В~линейной теории в~равновесии работа внешних сил на актуальных перемещениях, затраченная на~деформацию, равна удвоенной внутренней потенциальной энергии деформации. \inquotes{Запасается} всего половина потраченной энергии. Вторая половина это дополнительная энергия, она теряется до~обретения равновесия на~динамику~--- на~кинетическую энергию частиц (на \inquotes{диссипацию}), на~колебания и~волны. Так в~теории. Однако, в~реальности не~бывает ни~моментального \inquotes{мёртвого} нагружения, ни~бесконечномедленного \inquotes{следящего}. Это две крайности. Реальная динамика нагружения всегда где\hbox{-}то между ними. Посему теоретическая дополнительная энергия всегда больше той реальной \inquotes{диссипативной} кинетической, которая сопутствовала процессу нагружения, и~в~линейной теории она численно равна упругому потенциалу~--- половине работы внешних сил, той самой второй половине.

В~области~же бесконечномалых вариаций и~виртуальных работ, работа реальных внешних сил на виртуальных перемещениях точно равна вариации упругого потенциала. А~упругая среда есть такая, в~которой вариация работы сил внутренних (напряжений) на виртуальных деформациях это минус вариация потенциала.
...
Это та проблема линейной теории упругости, где простыми выкладками получаются нетривиальные результаты. Нетривиальное в~теории упругости это, например, когда \inquotes{деление силы на~площадь} даёт бесконечно больш\'{у}ю погрешность в~нахождении напряжения.
...
${\bm{r} = x_i \bm{e}_i}$,
${\bm{e}_i \bm{e}_i \hspace{-0.2ex} = \bm{E} \,\Leftrightarrow\hspace{.25ex} \bm{e}_i \hspace{-0.1ex} \dotp \bm{e}_j \hspace{-0.2ex} = \delta_{ij}}$.

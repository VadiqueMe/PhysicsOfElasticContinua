...
\boldnabla \dotp \mathboldtau \hspace{0.15ex} + \bm{f} = \hspace{0.1ex} \bm{0} \hspace{0.1ex}, \:\:
...
Как отмечалось в~\chapref{chapter:genericmechanics}, в~основу механики может быть положен d’Alembert\hbox{--}Lagrange principle виртуальной работы. Этот принцип справедлив и~в~линейной теории (внутренние силы в~упругой среде потенциальны: ${\variation{\internalwork} = -\variation{\Pi}}$)

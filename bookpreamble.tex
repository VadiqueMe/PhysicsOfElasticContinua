...
\makeatletter
\newcommand\infinitesim@lity{\infty^{\hspace{-0.4ex}\expminusone}}
\newcommand\infinitesimalof[1]{\scalebox{.9}{$\infinitesim@lity$}\hspace{-0.2ex}{#1}}
\makeatother
...
\newcommand\averageof[1]{{\langle #1 \rangle}}
...
\newcommand\boldvari@tionwithcomplexity[3]{\ensuremath\mathcolor{#3}{^{#2}\hspace{-0.1ex}\bm{\updelta}\hspace{-0.1ex}\bm{\mathrm{#1}}}}
\newcommand\varbivalentwithcomplexity[1]{\boldvari@tionwithcomplexity{#1}{2}{cyan!66!black}}
\newcommand\vartetravalent[1]{\boldvari@tionwithcomplexity{#1}{4}{teal!66!black}}
\makeatother
...
\newcommand{\sapproxabove}{%
	\hbox{\fontfamily{lmr}\fontsize{.66\dimexpr(\f@size pt)}{0}\selectfont$\,approx$}}
\DeclareRobustCommand{\mathapproxabove}{\accentset{\sapproxabove}}

\newcommand{\sasteriskabove}{%
	\hbox{\fontfamily{lmr}\fontsize{.66\dimexpr(\f@size pt)}{0}\selectfont$\,*$}}
\DeclareRobustCommand{\mathasteriskabove}{\accentset{\sasteriskabove}}

\newcommand{\scircabove}{%
	\hbox{\fontfamily{lmr}\fontsize{.66\dimexpr(\f@size pt)}{0}\selectfont$\,\circ$}}
...
\newcommand\timederivativedot{\hspace{-0.15ex} {\tikz[baseline=-0.2ex]\draw[black, fill=black] (0,0) circle (.266ex);} \hspace{-0.15ex}}
\newcommand\secondtimederivativedotdot{\hspace{-0.15ex} {\tikz[baseline=-0.2ex]\draw[black, fill=black] (0,0) circle (.266ex) (.8ex,0) circle (.266ex);} \hspace{-0.15ex}}
...
%%\newcommand\initialpotentialenergydensity{\uppi}
\newcommand\initialpotentialenergydensity{\smash{\hspace{-0.25ex}\mathcircabove{\hspace{.25ex}\potentialenergydensity}}}
\newcommand\potentialenergypermassunit{\smash{\widetilde{\potentialenergydensity}}}
...
\newcommand\nulloftheNthcomplexity[1]{{^{#1}\bm{0}}}

\newcommand\nullofthesecondcomplexity{\nulloftheNthcomplexity{2}}
\newcommand\zerobivalent{\nullofthesecondcomplexity}

\newcommand\nullofthefourthcomplexity{\nulloftheNthcomplexity{4}}
...
\newcommand\variedcauchystress{\varbivalent{\hspace{-0.2ex}\cauchystress}}
...
\newcommand\linearstresscomponents[1]{\mathsigma_{\hspace{-0.25ex}#1}}
...
\newcommand\infinimentpetitedeformationvariation{\varbivalent{\infinitesimaldeformation}}
\newcommand\insideinfinitesimalstrainvariation{\boldnabla \variation{\currentlocationvector}^{\hspace{.12ex}\mathsf{S}\hspace{-0.33ex}}}
...
\newcommand\massdensity{\rho}
\newcommand\initialmassdensity{\mathcircabove{\massdensity}}

\newcommand\Jacobian{\mathcal{J}} %% {J}
\newcommand\inverseJacobian{\Jacobian^{\hspace{.1ex}\expminusone}}
...
\renewcommand{\thempfootnote}{\arabic{mpfootnote}} % make minipage footnotes numeric

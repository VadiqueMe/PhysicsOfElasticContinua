...
\usepackage[X2,T2A,OT1,T1]{fontenc}
\usepackage{ucs}
...
\newcommand\boldconst{{\boldmath \const}}
...
\newcommand\varvector[1]{\ensuremath\bm{\updelta}\hspace{-0.125ex}\bm{\mathrm{#1}}}
...
\newcommand\Xcompanion{{\mathpalette\lowerXcompanion\times}} % symbol for X-companion
...
%%\newcommand\levicivita{\scalebox{1.2}[1]{$\textsf{Є}$}}
\newcommand\levicivitatensor{{^3\hspace{-0.05ex}\pmb{\scalebox{1.25}[1]{$\textsf{Є}$}}}\hspace{.05ex}}

\newcommand\stiffnesstensor{\hspace{.08ex}{^4\hspace{-0.72ex}\bm{\mathcal{A}}}\hspace{.08ex}}
...
\makeatletter
\def\@makefnmark{\raisebox{0.8ex}{\hbox{\normalfont\@thefnmark}}}
\makeatother

\let\originalfootnote\footnote
\renewcommand{\footnote}[1]{%
	\renewcommand\footnotesize\small%
	\originalfootnote{\hspace{0.25em}\parbox[t]{0.88\textwidth}{#1}}}
...
\g@addto@macro\@openbib@code{\setlength{\itemsep}{0.2em}}
\makeatother

\addto\captionsenglish{\def\bibliographyname{List of books}}
\addto\captionsenglish{\renewcommand{\bibname}{List of books}}

\addto\captionsrussian{\def\bibliographyname{Список литературы}}
\addto\captionsrussian{\renewcommand{\bibname}{Список литературы}}

\addto\captionsukrainian{\def\bibliographyname{Список літератури}}
\addto\captionsukrainian{\renewcommand{\bibname}{Список літератури}}

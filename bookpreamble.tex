...
\newcommand\permutationsparitysymbolslower[1]{\raisemath{.2ex}{\mathrm{\in}_{[#1]}}}
\newcommand\permutationsparitysymbols[1]{\permutationsparitysymbolslower{#1}}
\newcommand\permutationsparitysymbolsupper[1]{\raisemath{.2ex}{\mathrm{\in}^{[#1]}}}
...
\newcommand\withtheindexofperpendicularity[1]{{#1}_{\bot}}

...
\newcommand\permutationsparitysymbols{\raisemath{.2ex}{\mathrm{\in}}}
...
\newcommand\inertiatensorcircabove{{\hspace{-0.1ex}^2}\mathcircabove{\bm{\mathfrak{I}}}}
...
\newcommand\hcursive{\smash{\scalebox{0.9}{$\text{\textcursive{\slshape h}}$}\hspace{.5ex}}}

\newcommand\elcursive{\smash{\scalebox{0.9}{$\text{\textcursive{\slshape l}}$}\hspace{.5ex}}}
\newcommand\elcursivesub[1]{\smash{\scalebox{0.9}{$\text{\textcursive{\slshape l}}$}_{\raisemath{-0.22ex}{\hspace{.1ex}#1}}}}
...
\newcommand\smallerdisplaystyleonehalf{\scalebox{0.7}{$\raisemath{.1em}{\displaystyle \onehalf}$}\hspace{.1ex}}
...
% add the symbol of perpendicularity to the index of a given symbol
\newcommand\withtheindexofperpendicularity[1]{ #1_{\[UpTee]} }

% add the symbol of parallelism to the index of a given symbol
\newcommand\withtheindexofparallelism[1]{ #1_{\[DoubleVerticalBar]} }
...
\newcommand\infinitesimaldeformationcomponents[1]{\mathepsilon_{#1}}
...
\addto\captionsrussian{\def\figureshortname{рис.}} %%\def\figureshortname{фиг.}
...
\newcommand\rucontinuum{контину\kern-0.11exум}
\newcommand\ruContinuum{Контину\kern-0.11exум}
...
\addto\captionsenglish{\def\bibliographyname{List of referenced publications}}
\addto\captionsenglish{\renewcommand{\bibname}{\bibliographyname}}

\addto\captionsrussian{\def\bibliographyname{Список упомянутых публикаций}}
\addto\captionsrussian{\renewcommand{\bibname}{\bibliographyname}}

%%\addto\captionsukrainian{\def\bibliographyname{Список згаданих публікацій}}

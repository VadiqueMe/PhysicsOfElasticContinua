...
% put the symbol of perpendicularity into the index of a symbol
\newcommand\withtheindexofperpendicularity[1]{ #1_{\[UpTee]} }

% put the symbol of parallelism into the index of a symbol
...
\newcommand\zeroofthefirstcomplexity{{\bm{0}}}
\newcommand\zerovector{\zeroofthefirstcomplexity}
\newcommand\zeroofthesecondcomplexity{{^2\bm{0}}}
...
\newcommand\chapterdotsectionref[2]{\hyperref[#2]{\S\,\ref*{#1}.\ref*{#2}}}
\newcommand\chapterref[1]{\hyperref[#1]{\chaptershortname\:\ref*{#1}}}

\newcommand\figureref[1]{\figureshortname\:\ref{#1}}

\newcommandx*\customref[2][1=]{\hyperref[#2]{#1\ref*{#2}}}

\newcommand\eqrefwithchapdotsection[3]{\text{(\hyperref[#1]{\ref*{#1}},\:\chapterdotsectionref{#2}{#3})}}

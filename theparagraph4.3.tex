...
\en{Each case of symmetry}\ru{Каждый случай симметрии}
характеризует
набор ортогональных тензоров \bm{Q}.
Набор должен решать уравнение
${ \bm{Q} \dotp \bm{Q}^\T }$
...
\en{is characterized}\ru{характеризуется}
\en{by the set of orthogonal tensors}\ru{набором ортогональных тензоров}.

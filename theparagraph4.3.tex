...
\en{6×6 matrix}\ru{матрицей 6×6}

\nopagebreak\vspace{-.3ex}
\begin{gather}
\displaystyle
\underset{ \raisemath{.1em}{\scriptscriptstyle 6×6} }{ [ \hspace{.2ex} \mathcal{A} \hspace{.2ex} ] }
...
\en{is pretty}\ru{довольно\hbox{-}таки}
\en{cumbersome}\ru{громоздкая}:
...
\en{case of the symmetry}\ru{случай симметрии}
\en{is characterized}\ru{характеризуется}
...
${ \bm{Q} \dotp \bm{Q}^\T = \UnitDyad }$
( то есть \en{rotations}\ru{повороты} \en{and }\ru{и~}\en{reflections}\ru{отражения} ).


Для изотропного материала \eqref{Hooke's law for the symmetric crystals} удовлетворяется любым ортогональным тензором.
Проще принять, что ${ \potential(\lineardeformation) }$ становится изотропной функцией и~зависит лишь от инвариантов
из решения характеристического уравнения~\eqref{}

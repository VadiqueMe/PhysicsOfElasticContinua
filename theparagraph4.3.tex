...
\en{For an~isotropic material}\ru{Для изотропного материала}\en{,}
 \eqref{the Hooke's law for symmetric crystals} \en{is satisfied}\ru{удовлетворяется}
\en{by any orthogonal tensor}\ru{любым ортогональным тензором}~$\orthogonaltensor$.

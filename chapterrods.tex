...
= \hspace{-0.1ex} \rho \hspace{.15ex} \bigl( \fieldofdisplacements + \variedcauchystress \hspace{-0.2ex} \times \hspace{-0.3ex} \infinitesimaldeformation \bigr)^{ \hspace{-0.1ex} \tikz[baseline=-0.2ex] \draw[black, fill=black] (0,0) circle (.28ex); \hspace{.25ex} \tikz[baseline=-0.2ex] \draw[black, fill=black] (0,0) circle (.28ex); }
\hspace{-0.2ex} ,
\\
%

...
\en{Previously}\ru{До~этого}\en{,}
\en{the~question}\ru{вопрос}
\en{of~the~reference system}\ru{о~системе отсчёта}
\en{wasn’t raised}\ru{не~поднимался}.
%
\en{Everything}\ru{Всё}
\en{was considered}\ru{рассматривалось}
\en{in some}\ru{в~некой}
\inquotes{\en{absolute}\ru{абсолютной}}
\en{system}\ru{системе}
\en{or}\ru{или}
\en{one of inertial systems}\ru{одной из инерциальных систем}~(\sectionref{section:discreteapproach}).
%
\en{Now}\ru{Теперь}
\en{imagine}\ru{представьте себе}
\en{two systems}\ru{две системы},
\inquotes{\en{absolute}\ru{абсолютную}}
\en{and}\ru{и}~\inquotes{\en{moving}\ru{подвижную}}
....
...
\bm{x} = x_i \bm{e}_i
\\
\bigl( \initiallocationvector \bigr)^{\timederivativedot} \hspace{-0.1ex} = \mathdotabove{\locationvector} + \mathdotabove{\bm{x}}
\\
\mathdotabove{\locationvector} = \hspace{-0.1ex}
\mathdotabove{\rho}_i \hspace{.1ex} \mathcircabove{\bm{e}}_i
\hspace{.1ex} , \:\:
\mathdotabove{\bm{x}} = \hspace{-0.15ex} \bigl( x_i \bm{e}_i \bigr)^{\timederivativedot} \hspace{-0.1ex}
...
\begin{equation*}
\bm{v} \equiv \hspace{-0.1ex} \bigl( \initiallocationvector \bigr)^{\timederivativedot} \hspace{-0.1ex}
= \mathdotabove{\locationvector} + \mathdotabove{\bm{x}}
...
\begin{gather*}
\bigl( \initiallocationvector \bigr)^{\timederivativedot} \hspace{-0.1ex}
= \mathdotabove{\locationvector} + \mathdotabove{\bm{x}}
\\
\bigl( \initiallocationvector \bigr)^{\secondtimederivativedotdot} \hspace{-0.25ex}
= \mathdotdotabove{\locationvector} + \mathdotdotabove{\bm{x}}
\\
\bm{w} \equiv \hspace{.1ex} \mathdotabove{\bm{v}}
= \hspace{-0.15ex} \bigl( \initiallocationvector \bigr)^{\secondtimederivativedotdot} \hspace{-0.25ex}
= \mathdotdotabove{\locationvector} + \mathdotdotabove{\bm{x}}
\\
\mathdotdotabove{\locationvector} = \hspace{-0.1ex}
\mathdotdotabove{\rho}_i \hspace{.1ex} \mathcircabove{\bm{e}}_i
\hspace{.1ex} , \:\:
\mathdotdotabove{\bm{x}} = \hspace{-0.15ex} \bigl( x_i \bm{e}_i \bigr)^{\secondtimederivativedotdot} \hspace{-0.2ex}
= \hspace{-0.25ex} \bigl( \mathdotabove{x}_i \bm{e}_i \hspace{-0.1ex} + x_i \mathdotabove{\bm{e}}_i \bigr)^{\timederivativedot} \hspace{-0.1ex}
...
= \hspace{-0.15ex} \bigl( \hspace{.1ex} \bm{\omega} \hspace{-0.2ex} \times \hspace{-0.2ex} \bm{e}_i \hspace{.1ex} \bigr)^{\timederivativedot} \hspace{-0.1ex}
...
= x_i \bigl( \hspace{.1ex} \bm{\omega} \hspace{-0.2ex} \times \hspace{-0.2ex} \bm{e}_i \hspace{.1ex} \bigr)^{\timederivativedot} \hspace{-0.1ex}
...
\begin{equation*}
\begin{array}{c}
\bigl( x_i \mathdotabove{\bm{e}}_i \bigr)^{\timederivativedot} \hspace{-0.1ex}
...
%
\bigl( x_i \mathdotabove{\bm{e}}_i \bigr)^{\timederivativedot} \hspace{-0.1ex}
= \hspace{-0.15ex} \bigl( \hspace{.1ex} \bm{\omega} \hspace{-0.2ex} \times \hspace{-0.2ex} \bm{x} \hspace{.1ex} \bigr)^{\timederivativedot} \hspace{-0.1ex}

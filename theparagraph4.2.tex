...
\en{of the small displacement theory}\ru{теории малых смещений}
...
\vspace{.3em}
\en{For}\ru{Для}
\en{the~left\hbox{-}hand side}\ru{левой части}
...
\en{in the generic case}\ru{в~общем случае}
\en{by simple}\ru{простыми}
\en{conclusions}\ru{выводами}.
\en{I could only tell}\ru{Я могу лишь сказать}\ru{,} \en{that}\ru{что}
...
\en{lack}\ru{лишены} \en{the mathematical scrupulosity}\ru{математической щепетильности},
\en{inherent}\ru{присущей},
\en{for example}\ru{например},
\en{to}\ru{для} \en{the}\ru{монографии} Philippe\ru{’а} Ciarlet’\en{s}\ru{а}\en{ monograph}~\cite{ciarlet-mathematicalelasticity}.

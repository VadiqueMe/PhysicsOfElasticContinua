...
% equality
\subsection*{\en{The equality}\ru{Равенство}}
...
\en{their complexities (valencies)}\ru{их сложности (валентности)}
\en{are the~same}\ru{одинаковы}.
\en{Tensors of the different valencies}\ru{Тензоры разных валентностей}
\en{cannot be}\ru{не~могут быть}
\en{equal or not}\ru{равн\'{ы} или не~равн\'{ы}}.
...
% linear combination
\subsection*{\en{The linear combination}\ru{Линейная комбинация}}
...
\begin{equation}\label{tensoraction:linearcombination}
...
\en{representation}\ru{представление} \en{of~a~vector}\ru{вектора} \en{as the~sum}\ru{суммой}~${\bm{v} = v_i \bm{e}_i}$\:--- \en{is nothing else but}\ru{это не~что~иное как} \en{the~linear combination}\ru{линейная комбинация} \en{of~basis vectors}\ru{векторов базиса}~${\bm{e}_i}$ \en{with coefficients}\ru{с~коэффициентами}~${v_i}$.

	...
	\draw [line width=1.6pt, blue, line cap = round, -{Stealth[round, length=5mm, width=2.8mm]}]
		...
		node [pos=0.5, above right, inner sep=1pt, outer sep=3pt]
			{$ \smalldisplaystyleonehalf \hspace{.12ex} d\bm{a} \dotp \bm{n}_1 \bm{n}_1 \hspace{-0.2ex}
				+ \hspace{-0.16ex} \infinitesimalof{(d\bm{a})} $} ;
...
\[\begin{array}{c}
%%d\mathcal{V} = d\xi_i \bm{n}_i \hspace{-0.1ex} \times \hspace{-0.16ex} d \xi_j \bm{n}_j \hspace{-0.12ex} \dotp d \xi_k \bm{n}_k = \hspace{-0.16ex} \permutationsparitytensor_{i\hspace{-0.1ex}jk} \hspace{.2ex} d\xi_i d\xi_j d\xi_k
%%\\[.25em]

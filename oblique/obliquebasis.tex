...
\begin{tikzpicture}[x=1\tikzunit, y=1\tikzunit, scale=\scaleofunits]
	...
	\edef\cofirstdotcosecondxint{ \xinttheexpr round( - \gramianreciprocal * \firstdotsecond , 10 ) \relax }%
	...
	\pic [draw, <-, color=red!50!blue, line cap=round, dash pattern=on 0pt off 4\pgflinewidth,
		angle radius=\vectorprojfirstinunits, angle eccentricity=0.92,
	...
	\pic [draw, ->, color=red!50!blue, line cap=round, dash pattern=on 0pt off 4\pgflinewidth,
		angle radius=\vectorcocofirstinunits, angle eccentricity=1.09,

...
\en{on the linear elasticity}\ru{о~линейной упругости}.
...
%%%\textcolor{red}{\en{It is known that}\ru{Известно, что}}
\en{On torsion}\ru{От кручения}\en{,}
\ru{возникают }\en{the tangential}\ru{касательные}
\en{stress components}\ru{компоненты напряжения}
${
   \mathtau_{z1}
   \equiv \bm{k}
   \dotp
...
\en{components}\ru{компоненты}\en{ of}~$\linearstress$
...
\withtheindexofperpendicularity{\boldnabla}\hspace{-0.33ex} \dotp \bm{s} = \zerovector
\hspace{1ex}
(\withtheindexofperpendicularity{\boldnabla}\hspace{-0.4ex} \equiv \bm{e}_{\alpha} \partial_{\alpha})
\hspace{.1ex} ,
\hspace{.66ex}
\partial_{z} \bm{s}
= \zerovector
...
\\
%
\boldnabla \hspace{-0.2ex} \dotp \hspace{-0.25ex} \boldnabla \linearstress
+ \scalebox{.9}{$ \displaystyle\frac{1}{1 + \poissonratio} $} \boldnabla \boldnabla \mathsigma
\hspace{.1ex} = \hspace{-0.2ex} \zerobivalent
\hspace{.2em} \Rightarrow \hspace{.2em}
\withtheindexofperpendicularity{\Laplacian}\hspace{-0.2ex} \bm{s}
= \zerovector
\hspace{1ex}
(\withtheindexofperpendicularity{\Laplacian}\hspace{-0.5ex} \equiv \partial_{\alpha} \partial_{\alpha})
\hspace{.1ex} .
\end{align}
